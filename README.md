...
MZmine is an open-source software for mass-spectrometry data processing. The goal of the project is
...
options include portable versions and installers for  Windows, macOS, and Linux.

### Running on macOS

Currently, MZmine 3 lacks a signature for macOS. While we are working on this, the user can allow MZmine

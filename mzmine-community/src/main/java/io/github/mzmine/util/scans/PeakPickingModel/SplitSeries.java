...
public class SplitSeries {
    ...
    public static final double[] extractSingleRegion(FeatureFullDataAccess fullSeries, int start, int regionSize){
        double[] standardRegion = new double[regionSize];
        System.arraycopy(fullSeries.getIntensityValues(), start , standardRegion, 0, regionSize);
    ...
    public static final List<double[]> extractRegionBatch(FeatureFullDataAccess fullSeries, int regionSize){
        int seriesLength = fullSeries.getIntensityValues().length;
        ...
        System.arraycopy(fullSeries.getIntensityValues(), 0,paddedSeries,0, seriesLength);
    ...
    public static final List<double[]> extractRegionBatch(FeatureFullDataAccess fullSeries){

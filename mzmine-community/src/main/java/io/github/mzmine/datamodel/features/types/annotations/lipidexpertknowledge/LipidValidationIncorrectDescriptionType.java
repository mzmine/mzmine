...
/**
 * This class represents the column of negative evidence found for the feature in Lipid Validation
 * It will be displayed in the feature list table in the GUI under the name "Incorrect comments".
 */

...
/**
 * A synthetic feature that aggregates per-{@link io.github.mzmine.datamodel.RawDataFile}
 * intensity values onto a {@link ModularCompoundRow}. Distinct from a regular
 ...
 * representative source row's feature for any {@link io.github.mzmine.datamodel.features.types.DataType}
 * not explicitly set on the compound feature.
 */
public interface CompoundFeature extends Feature {
  ...
  @NotNull ModularFeatureListRow getRepresentativeRow();
}

...
public class MassLynxLib {
  ...
  private static SymbolLookup getSymbolLookup() {
    ...
    System.load(
        Path.of("external_tools\\waters_raw\\MassLynxRaw.dll")
   ...
   * Function descriptor for:
   * {@snippet lang = c:
   * int32_t closeFile(Handle handle)
   *}
   */
   ...
   * Function descriptor for:
   * {@snippet lang = c:
   * int32_t setCentroid(Handle handle, int32_t centroid)
   *}
   */
   ...
   * Function descriptor for:
   * {@snippet lang = c:
   * int32_t applyAutoLockmassCorrection(Handle handle)
   *}
   */
   ...
   * Function descriptor for:
   * {@snippet lang = c:
   * int32_t applyCustomLockmassCorrection(Handle handle, float lockmass)
   *}
   */
   ...
   * Function descriptor for:
   * {@snippet lang = c:
   * int32_t isIonMobilityFile(Handle handle)
   *}
   */
   ...
   * Function descriptor for:
   * {@snippet lang = c:
   * int32_t getNumberOfMobilityScans(Handle handle, int32_t function)
   *}
   */
   ...
   * Function descriptor for:
   * {@snippet lang = c:
   * int32_t isIonMobilityFunction(Handle handle, int32_t function)
   *}
   */
   ...
   * Function descriptor for:
   * {@snippet lang = c:
   * int32_t isDdaFile(Handle handle)
   *}
   */
   ...
   * Function descriptor for:
   * {@snippet lang = c:
   * int32_t getDataPoints(Handle handle, int32_t function, int32_t scan, float *pMzBuffer, float *pIntensityBuffer, uint32_t bufferSizeInBytes)
   *}
   */

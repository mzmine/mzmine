...
public class RtCalibrationMedianPreviewPane extends AbstractPreviewPane<List<FeatureList>> {

  private static final Logger logger = Logger.getLogger(RtCalibrationMedianPreviewPane.class.getName());
   ...
   * @param parameters
   */
  public RtCalibrationMedianPreviewPane(ParameterSet parameters) {
    super(parameters);
  }

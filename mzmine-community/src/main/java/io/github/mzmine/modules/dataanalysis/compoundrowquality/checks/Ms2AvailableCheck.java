...
public final class Ms2AvailableCheck implements QualityCheck {
  ...
  public @NotNull QualityCheckResult evaluate(@NotNull CompoundRow row,
    ...
    if (withMs2 == 0) {
      return new QualityCheckResult(QualityCheckType.MS2_AVAILABLE, QualityCheckStatus.WARN,
    ...
    return new QualityCheckResult(QualityCheckType.MS2_AVAILABLE, QualityCheckStatus.PASS, summary,
        List.of(), involved);
  }
}

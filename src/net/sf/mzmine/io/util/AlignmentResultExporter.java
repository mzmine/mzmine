...
public class AlignmentResultExporter {
     ...
     * @param parameters User-definable parameters (defines which columns to
     *            export)
     * 
    ...
    public boolean exportToFile(AlignmentResult alignmentResult,
        ...
        try {
            ...
            logger.warning("Could not open file " + outputFile
                    + " for writing.");
            return false;
        }
        ...
        for (AlignmentResultRow alignmentRow : alignmentResult.getRows()) {
            ...
            for (CommonColumnType c : selectedCommonColumns) {
                ...
                /*
                 * case STDCOMPOUND: if
                 * (alignmentRow.hasData(StandardCompoundFlag.class)) s +=
                 * "1\t"; else s+="0\t"; break;
                 */
                case ROWNUM:
                    s += "" + (row + 1) + "\t";
                    ...
                    if (p == null) {
                        ...
                        case STATUS:
                            ...
                            if (ps == null) {
                                ...
                                // TODO: Numerical values for DETECTED and
                                // ESTIMATED are hard coded here
                                switch (ps) {
                                case DETECTED:
                                    s += "1\t";
                                    break;

...
import net.sf.mzmine.io.MZmineOpenedFile.Operation;
 ...
 *
 */
public class MZmineOpenedFileImpl implements MZmineOpenedFile {
    ...
    public MZmineOpenedFileImpl(RawDataFile rawDataFile, String dataDescription) {
    ...
    /**
     * @see net.sf.mzmine.io.MZmineOpenedFile#getHistory()
     */
    ...
    /**
     * @see net.sf.mzmine.io.MZmineOpenedFile#getDataDescription()
     */
    ...
    /**
     * @see net.sf.mzmine.io.MZmineOpenedFile#getCurrentFile()
     */
    ...
    /**
     * @see net.sf.mzmine.io.MZmineOpenedFile#updateFile(net.sf.mzmine.io.RawDataFile, net.sf.mzmine.methods.Method, net.sf.mzmine.methods.MethodParameters)
     */
    ...
    /**
     * @see net.sf.mzmine.io.MZmineOpenedFile#addFileChangedListener()
     */
    ...
    /**
     * @see net.sf.mzmine.io.MZmineOpenedFile#getOriginalFile()
     */
    ...
    /**
     * @see net.sf.mzmine.io.MZmineOpenedFile#addHistoryEntry(net.sf.mzmine.methods.Method, net.sf.mzmine.methods.MethodParameters)
     */
    ...
    /**
     * @see net.sf.mzmine.io.MZmineOpenedFile#addHistoryEntry(net.sf.mzmine.io.MZmineOpenedFile.Operation)
     */

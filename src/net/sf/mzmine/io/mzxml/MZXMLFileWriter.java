...
/**
 * This class represent a writer for mzXML files.
 * TODO: Currently writes only minimum amount of information in slightly ugly formatting
 */
public class MZXMLFileWriter implements RawDataFileWriter {
    ...
    public Scan createScan(	int scanNumber,
		...
		MZXMLScan newScan = new MZXMLScan(	scanNumber,
											msLevel,
											precursorMZ,
											retentionTime,
											basePeakMZ,
		...
		Duration dur = datatypeFactory.newDuration( (long) (java.lang.Math.round( 1000 * newScan.getRetentionTime() ) ) );
    ...
    public RawDataFile finishWriting() throws IOException {
		...
		// Unimplemented: index is not needed in temporary copy because offsets are given to MZXMLFile already during addScan()

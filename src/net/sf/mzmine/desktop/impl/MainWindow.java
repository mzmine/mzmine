...
public class MainWindow extends JFrame implements MZmineModule, Desktop,
		WindowListener, ApplicationListener, ProjectListener {
	...
	/**
	 * @see net.sf.mzmine.desktop.Desktop#isDataFileSelected()
	 */
	...
	/**
	 * @see net.sf.mzmine.desktop.Desktop#addMenuItem(net.sf.mzmine.desktop.Desktop.MZmineMenu,
	...
	/**
	 * @see net.sf.mzmine.desktop.Desktop#addMenuSeparator(net.sf.mzmine.desktop.Desktop.MZmineMenu)
	 */
	...
	/**
	 * @see net.sf.mzmine.desktop.Desktop#getVisibleFrames()
	 */

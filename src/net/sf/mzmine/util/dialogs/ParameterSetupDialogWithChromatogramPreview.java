...
public abstract class ParameterSetupDialogWithChromatogramPreview extends
	...
	private void reloadPreview() {
		...
		Range rtRange = rtRangeBox.getRangeValue();
		Range mzRange = mzRangeBox.getRangeValue();
	...
	private void addExtraComponents() {
		...
		if (previewDataFile != null) {
			...
			rtRangeBox.setRangeValue(previewDataFile.getDataRTRange(1));
			
			mzRangeBox = new RangeComponent(MZmineCore.getMZFormat());
			mzRangeBox.setRangeValue(previewDataFile.getDataMZRange(1));
		...
		mainPanel.add(pnlPreviewFields, 0, parametersAndComponents.size() + 3,
				3, 1, 0, 0);

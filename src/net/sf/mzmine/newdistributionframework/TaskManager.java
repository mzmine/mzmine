 ...
 * 
 */
package net.sf.mzmine.newdistributionframework;
...
public class TaskManager implements Runnable {
    ...
    public TaskManager(int numberOfWorkers) {
        ...
        workerNodes = new Node[numberOfWorkers];
        taskQueue = new PriorityBlockingQueue<Task>(10, new TaskPriorityComparator());

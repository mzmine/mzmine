...
public class XcaliburRawFileReadTask implements Task {
     ...
     * current scan information. These fields are referred as common fields in
     * later comments.
     */
    ...
    public void startScan() throws IOException {
        ...
        /*
         * This section verify if the current scan is a full scan. If this
         * condition is true means that the previous scans (scan/fragments),
         * stored in the stack, are complete and ready to be written in
         * MZmineFile.
         */
    ...
    /*
     * This method clean all common fields for the next scan. The native code
     * calls this after each single call of startScan method.
     */
    public void clean() {
        scanNumber = 0;
        msLevel = 0;

...
import net.sf.mzmine.modules.masslistmethods.massfilters.MassFilterSetupDialog;
import net.sf.mzmine.modules.masslistmethods.massfilters.MassFilteringParameters;
...
public class ShoulderPeaksFilterParameters extends SimpleParameterSet {
	...
	public ShoulderPeaksFilterParameters() {
		super(new UserParameter[] { MassFilteringParameters.massList, resolution, peakModel });

	}

	public ExitCode showSetupDialog() {
		MassFilterSetupDialog dialog = new MassFilterSetupDialog(
				ShoulderPeaksFilter.class, this);

...
public class DataSetFiltersParameters implements StorableParameterSet {
	 ...
	 * 
	 */
	public DataSetFiltersParameters clone() {

		DataSetFiltersParameters newSet = new DataSetFiltersParameters();

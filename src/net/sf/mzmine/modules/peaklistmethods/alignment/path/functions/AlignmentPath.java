...
public class AlignmentPath implements Comparable<AlignmentPath>, Cloneable {
        ...
        /*  public boolean matchesWithName(PeakListRow peak) {
         ...
         */
        /*  public boolean matchesWithName(PeakListRow p) {
        for (String curName : p.names()) {
        if (names.contains(curName) &&
        !curName.equals(PeakListRow.UNKOWN_NAME)) {
        return true;
        }
        }
        return false;
         ...
         * @return
         */
        /* public AlignmentPath mergeWith(AlignmentPath other, ScoreCalculator calc, GraphAlignerParameters params) {
        if (other == null) {
        return clone();
        }
        ...
        double gapPenalty = params.getParameter(GraphAlignerParameters.RTTolerance).getValue().getTolerance() * 0.2;// params.getParameter(ScoreAlignmentParameters.rt1Lax).getDouble() * params.getParameter(ScoreAlignmentParameters.rt1Penalty).getDouble() + params.getParameter(ScoreAlignmentParameters.rt2Lax).getDouble() * params.getParameter(ScoreAlignmentParameters.rt2Penalty).getDouble() + params.getParameter(ScoreAlignmentParameters.rtiLax).getDouble() * params.getParameter(ScoreAlignmentParameters.rtiPenalty).getDouble();

...
import net.sf.mzmine.modules.peaklistmethods.identification.formulaprediction.restictions.elements.ElementalHeuristicChecker;
import net.sf.mzmine.modules.peaklistmethods.identification.formulaprediction.restictions.rdbe.RDBERestrictionChecker;
...
public class SingleRowPredictionTask extends AbstractTask {
	...
	private void checkConstraints(MolecularFormula cdkFormula) {
		...
		if ((checkIsotopes) && (detectedPattern != null)) {
			...
			IMolecularFormula adjustedFormulaObject = FormulaUtils
					.ionizeFormula(cdkFormula, ionType, charge);
			String adjustedFormula = MolecularFormulaManipulator

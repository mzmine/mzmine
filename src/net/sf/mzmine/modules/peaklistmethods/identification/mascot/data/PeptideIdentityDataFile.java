...
public class PeptideIdentityDataFile{
	...
	/**
	 * Returns a map, containing the information about 
	 * the protein hits and corresponding query (identified peptide).
	 */
	...
	public SerieIonType[] getIonSeriesRules() {
		if (ionSeriesRules == null)
			ionSeriesRules = MascotParserUtils.parseFragmentationRules((String) this.getParameters().get("RULES"));

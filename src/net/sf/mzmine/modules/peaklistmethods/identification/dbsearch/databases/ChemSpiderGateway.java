...
public class ChemSpiderGateway implements DBGateway
{
    ...
    @Override
    public String[] findCompounds(final double mass, final double massTolerance, final int numOfResults)
            throws IOException
    {
        LOG.finest("Searching by mass...");

        // These are returned in #CSID (numerical) order.
        final String[] results = createMassSpecAPI().searchByMass2(mass, massTolerance);

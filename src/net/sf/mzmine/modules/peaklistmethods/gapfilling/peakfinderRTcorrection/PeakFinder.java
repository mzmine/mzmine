...
public class PeakFinder implements BatchStep, ActionListener {
    ...
    private final String helpID = "net/sf/mzmine/modules/gapfilling/peakfinderRTcorrection/help/PeakFinder.html";
    ...
    public void initModule() {
        ...
        desktop.addMenuItem(MZmineMenu.GAPFILLING, "Corrected Peak finder",
    ...
    public ExitCode setupParameters(ParameterSet currentParameters) {
        ParameterSetupDialog dialog = new ParameterSetupDialog(
                ...
                (PeakFinderParameters) currentParameters, helpID);
    ...
    public Task[] runModule(RawDataFile[] dataFiles, PeakList[] peakLists,
        ...
        if (peakLists == null || peakLists.length < 1) {
            throw new IllegalArgumentException(
                    "Corrected Gap-filling requires a peak list");
        }

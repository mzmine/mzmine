...
public class Chromatogram implements ChromatographicPeak {
	...
	// Marks if the chromatogram was modified since last calculation of m/z, RT,
	// height, area etc.
	private boolean chromatogramModified = false;
	...
	private void updateChromatogramVariables() {

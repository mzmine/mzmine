...
public class SelectiveConnector implements MassConnector {
	...
	public SelectiveConnector(SelectiveConnectorParameters parameters) {

		minimumTimeSpan = (Double) parameters
				.getParameterValue(SelectiveConnectorParameters.minimumTimeSpan);
		minimumHeight = (Double) parameters
				.getParameterValue(SelectiveConnectorParameters.minimumHeight);
		mzTolerance = (Double) parameters
				.getParameterValue(SelectiveConnectorParameters.mzTolerance);

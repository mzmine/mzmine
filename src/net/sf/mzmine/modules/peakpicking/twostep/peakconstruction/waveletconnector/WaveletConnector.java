...
package net.sf.mzmine.modules.peakpicking.twostep.peakconstruction.waveletconnector;
...
public class WaveletConnector implements PeakBuilder {
	...
	public WaveletConnector(WaveletConnectorParameters parameters) {
		...
		chromatographicThresholdLevel = (Float) parameters
				.getParameterValue(WaveletConnectorParameters.chromatographicThresholdLevel);
		chromatographicFilter = (Boolean) parameters
				.getParameterValue(WaveletConnectorParameters.chromatographicFilter);

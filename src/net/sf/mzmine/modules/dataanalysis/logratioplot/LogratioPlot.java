...
public class LogratioPlot extends ChartPanel {
	...
	public LogratioPlot(LogratioAnalyzerWindow masterFrame, LogratioDataset dataset) {
		super(null);
		...
		spotRenderer = new LogratioRenderer(dataset, paintScale);

 ...
 * 
 */
public class QBIXLipidDBSearch implements BatchStepIdentification, ActionListener {

    public static final String MODULE_NAME = "QBIX lipid database search";
    ...
    public void initModule() {
        ...
        parameters = new QBIXLipidDBSearchParameters();
    ...
    public void setParameters(ParameterSet parameterValues) {
        this.parameters = (QBIXLipidDBSearchParameters) parameterValues;
    }
    ...
    public TaskGroup runModule(RawDataFile[] dataFiles, PeakList[] peakLists,
        ...
        Task tasks[] = new QBIXLipidDBSearchTask[peakLists.length];
        for (int i = 0; i < peakLists.length; i++) {
            tasks[i] = new QBIXLipidDBSearchTask(peakLists[i],

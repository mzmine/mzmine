...
package net.sf.mzmine.modules.identification.dbsearch.databases;
...
import net.sf.mzmine.modules.identification.dbsearch.DBCompound;
import net.sf.mzmine.modules.identification.dbsearch.DBGateway;
...
public class KEGGGateway implements DBGateway {
	...
	public String[] findCompounds(double mass, double massTolerance,
		...
		String[] results = serv.search_compounds_by_mass((float) mass,
				(float) massTolerance);

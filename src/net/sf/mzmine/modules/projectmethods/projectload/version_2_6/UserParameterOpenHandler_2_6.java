...
public class UserParameterOpenHandler_2_6 extends DefaultHandler implements
	...
	public UserParameterOpenHandler_2_6(MZmineProject newProject,
	...
	public void startElement(String namespaceURI, String lName, String qName,
		...
		// <PARAMETERS>
		if (qName.equals(UserParameterElementName_2_6.PARAMETERS
				.getElementName())) {
			String count = attrs.getValue(UserParameterElementName_2_6.COUNT
					.getElementName());
			totalParams = Integer.parseInt(count);
		}

		// <PARAMETER>
		if (qName.equals(UserParameterElementName_2_6.PARAMETER
				.getElementName())) {

			String name = attrs.getValue(UserParameterElementName_2_6.NAME
					.getElementName());
			String type = attrs.getValue(UserParameterElementName_2_6.TYPE
					.getElementName());
		...
		// <VALUE>
		if (qName.equals(UserParameterElementName_2_6.VALUE.getElementName())) {
			currentDataFileID = attrs
					.getValue(UserParameterElementName_2_6.DATA_FILE
							.getElementName());
		}
	...
	public void endElement(String namespaceURI, String sName, String qName)
		...
		// <OPTION>
		if (qName.equals(UserParameterElementName_2_6.OPTION.getElementName())) {

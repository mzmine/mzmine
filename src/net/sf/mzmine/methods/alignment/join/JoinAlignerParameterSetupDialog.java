 ...
 */
public class JoinAlignerParameterSetupDialog extends JDialog implements ActionListener {
	 ...
	 * Constructor
	 */
	public JoinAlignerParameterSetupDialog(JFrame owner, String title, JoinAlignerParameters _params) {

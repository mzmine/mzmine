...
class CropFilterRun implements TaskListener, Runnable {
     ...
     */
    CropFilterRun(CropFilter moduleInstance, OpenedRawDataFile[] dataFiles, ParameterSet parameters,
            MethodListener methodListener, Desktop desktop, TaskController taskController) {
    ...
    public synchronized void taskFinished(Task task) {
        ...
        if (task.getStatus() == Task.TaskStatus.FINISHED) {
            ...
            if (returnStatus == null) returnStatus = MethodReturnStatus.FINISHED;

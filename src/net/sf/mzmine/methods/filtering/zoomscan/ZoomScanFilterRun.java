 ...
 * 
 */
class ZoomScanFilterRun implements TaskListener, Runnable {

    private Logger logger = Logger.getLogger(this.getClass().getName());

    private ZoomScanFilter moduleInstance;
    private ParameterSet parameters;
    private ZoomScanFilterTask tasks[];
    private MethodListener methodListener;
    private Desktop desktop;
    private TaskController taskController;
    private Hashtable<ZoomScanFilterTask, OpenedRawDataFile> taskToFile;
     ...
     */
    ZoomScanFilterRun(ZoomScanFilter moduleInstance,
        ...
        taskToFile = new Hashtable<ZoomScanFilterTask, OpenedRawDataFile>();

        taskCount = dataFiles.length;
        tasks = new ZoomScanFilterTask[taskCount];
    ...
    public void run() {
        ...
        for (ZoomScanFilterTask filterTask : tasks) {

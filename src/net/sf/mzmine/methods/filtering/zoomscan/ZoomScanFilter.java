...
public class ZoomScanFilter implements Method, ListSelectionListener,
        ActionListener {
    ...
    public void runMethod(OpenedRawDataFile[] dataFiles,
        ...
        ZoomScanFilterRun newRun = new ZoomScanFilterRun(this, dataFiles,
                parameters, methodListener, desktop, taskController);

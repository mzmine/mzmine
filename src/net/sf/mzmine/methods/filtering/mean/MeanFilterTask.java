 ...
 *
 */
public class MeanFilterTask implements Task {
    ...
    public void run() {
		...
		for (int i = 0; i < scanNumbers.length; i++) {
			...
			try {
				...
				processOneScan(rawDataFileWriter, oldScan, parameters.oneSidedWindowLength);
	...
	private void processOneScan(RawDataFileWriter writer, Scan sc, double windowLength) throws IOException {

 ...
 *
 */
public class SavitzkyGolayFilterTask implements Task {
     ...
     * @param parameters
     */
    SavitzkyGolayFilterTask(RawDataFile rawDataFile, SavitzkyGolayFilterParameters parameters) {
    ...
    public void run() {
		...
		for (int i = 0; i < scanNumbers.length; i++) {
			...
			try {
				...
				processOneScan(rawDataFileWriter, oldScan, parameters.numberOfDataPoints, h, aVals);
	...
	private void processOneScan(RawDataFileWriter writer, Scan sc, int numOfDataPoints, int h, int[] aVals) throws IOException {

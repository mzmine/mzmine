 ...
 * 
 */
class CMFilterRun implements TaskListener, Runnable {

    private Logger logger = Logger.getLogger(this.getClass().getName());

    private CMFilter moduleInstance;
    private ParameterSet parameters;
    private CMFilterTask tasks[];
    private MethodListener methodListener;
    private Desktop desktop;
    private TaskController taskController;
    private Hashtable<CMFilterTask, OpenedRawDataFile> taskToFile;
     ...
     */
    CMFilterRun(CMFilter moduleInstance, OpenedRawDataFile[] dataFiles,
        ...
        taskToFile = new Hashtable<CMFilterTask, OpenedRawDataFile>();

        taskCount = dataFiles.length;
        tasks = new CMFilterTask[taskCount];
    ...
    public void run() {
        ...
        for (CMFilterTask filterTask : tasks) {

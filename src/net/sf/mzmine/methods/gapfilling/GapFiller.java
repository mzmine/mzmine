...
package net.sf.mzmine.methods.gapfilling;
...
public interface GapFiller {
	 ...
	 */
	public Hashtable<Integer, double[]> fillGaps(Hashtable<Integer, double[]> gapsToFill, RawDataFile rawData, GapFillerParameters parameters);

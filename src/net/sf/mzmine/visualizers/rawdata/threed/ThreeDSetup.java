...
public class ThreeDSetup {
    ...
    public static void showSetupDialog(RawDataFile rawDataFile) {
        ...
        paramNames[5] = "Max. retention time resolution";
        paramNames[6] = "M/Z resolution";
        ...
        paramValues[5] = 2000;
        paramValues[6] = Math.round(rawDataFile.getDataMaxMZ(1)
                - rawDataFile.getDataMinMZ(1));
        ...
        ParameterSetupDialog psd = new ParameterSetupDialog(mainWin,
                "3D visualizer parameters (" + rawDataFile + ")", paramNames,
        ...
        new ThreeDVisualizer(rawDataFile, msLevel, rtMin, rtMax, mzMin, mzMax,

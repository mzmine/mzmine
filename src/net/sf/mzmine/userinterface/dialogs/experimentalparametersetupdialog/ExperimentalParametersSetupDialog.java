...
public class ExperimentalParametersSetupDialog extends JDialog implements
		ActionListener {
	...
	public void actionPerformed(ActionEvent actionEvent) {
		...
		if (src == buttonImportParameters) {
			...
			ExperimentalParametersImporter importer = new ExperimentalParametersImporter(
					this);
	...
	private void setupTableModel() {
		...
		tablemodelParameterValues = new ExperimentalParametersSetupDialogTableModel(

...
//          fileOpenChooser.setCurrentDirectory(new File(dataDirectory));
 ...
 /*       if (src == fileExportPeakList) {
                ...
                if (!r.hasPeakData()) {
                    ...
                    if(retval == JFileChooser.APPROVE_OPTION) {
                        ...
                        if (PeakListExporter.writePeakListToFile(r, peakListName)) {
                            ...
                            mainWin.displayErrorMessage("Failed to write peak list for raw data " + r.getNiceName());
                            statBar.setStatusText("Peak list export failed.");
                        }
            ...
            if (results.size()>0) {
                AlignmentResultExporterParameters areParams = mainWin.getParameterStorage().getAlignmentResultExporterParameters();
                GeneralParameters genParams = mainWin.getParameterStorage().getGeneralParameters();
                ...
                arepsd.showModal(mainWin.getDesktop);
        ...
        //  fileOpenChooser.setCurrentDirectory(new File(clientForCluster.getDataRootPath()));
            ...
            if(retval == JFileChooser.APPROVE_OPTION) {
                ...
                if (mainWin.getParameterStorage().readParametesFromFile(selectedFile)) {
        ...
        if (src == ssRecursiveThresholdPicker) {
            ...
            RecursiveThresholdPickerParameters rpParam = rp.askParameters(this, mainWin.getParameterStorage().getRecursiveThresholdPickerParameters());
            if (rpParam == null) {
        ...
        if (src == ssLocalPicker) {
            ...
            LocalPickerParameters lpParam = lp.askParameters(this, mainWin.getParameterStorage().getLocalPickerParameters());
            if (lpParam == null) {
                statBar.setStatusText("Peak picking cancelled.");
                return;
            }
        ...
        if (src == ssCentroidPicker) {
            ...
            CentroidPickerParameters cpParam = cp.askParameters(this, mainWin.getParameterStorage().getCentroidPickerParameters());
            if (cpParam == null) {
                statBar.setStatusText("Peak picking cancelled.");
                return;
            }
        ...
        if (src == ssSimpleDeisotoping) {
            ...
            SimpleDeisotoperParameters sdParam = sd.askParameters(this, mainWin.getParameterStorage().getSimpleDeisotoperParameters());
            if (sdParam == null) {
        ...
        if (src == ssCombinatorialDeisotoping) {
            ...
            CombinatorialDeisotoperParameters cdParam = cd.askParameters(this, mainWin.getParameterStorage().getCombinatorialDeisotoperParameters());
            if (cdParam == null) {
                statBar.setStatusText("Deisotoping cancelled.");
                return;
            }
        ...
        if (src == ssIncompleteIsotopePatternFilter) {
            ...
            IncompleteIsotopePatternFilterParameters iifParam = iif.askParameters(this, mainWin.getParameterStorage().getIncompleteIsotopePatternFilterParameters());
            if (iifParam == null) {
        ...
        if (src == tsJoinAligner) {
            ...
            JoinAlignerParameters jaParam = ja.askParameters(this, mainWin.getParameterStorage().getJoinAlignerParameters());
            if (jaParam==null) {
        ...
        if (src == tsFastAligner) {
            ...
            FastAlignerParameters faParam = fa.askParameters(this, mainWin.getParameterStorage().getFastAlignerParameters());
            if (faParam==null) {
                statBar.setStatusText("Alignment cancelled.");
                return;
            }
        ...
        if (src == normLinear) {
            ...
            LinearNormalizerParameters lnp = ln.askParameters(this, mainWin.getParameterStorage().getLinearNormalizerParameters());
            if (lnp == null) {
        ...
        if (src == normStdComp) {
            ...
            StandardCompoundNormalizerParameters scnp = scn.askParameters(this, mainWin.getParameterStorage().getStandardCompoundNormalizerParameters());
            if (scnp==null) {
                statBar.setStatusText("Normalization cancelled.");
                return;
            }
        ...
        if (src == tsAlignmentFilter) {
            ...
            AlignmentResultFilterByGapsParameters arfbgParam= arfbg.askParameters(this, mainWin.getParameterStorage().getAlignmentResultFilterByGapsParameters());
            if (arfbgParam == null) {
        ...
        if (src == tsEmptySlotFiller) {
            ...
            SimpleGapFillerParameters sgfParam= sgf.askParameters(this, mainWin.getParameterStorage().getSimpleGapFillerParameters());
            if (sgfParam == null) {
    ...
    //      clientForCluster.fillGaps(alignmentResult, sgfParam);
        ...
        if (src == anOpenCDAView) {
            ...
            Vector<AlignmentResult> rv = itemSelector.getSelectedAlignmentResults();
            for (AlignmentResult ar : rv ) {
                mainWin.addAlignmentResultVisualizerCDAPlot(ar);
            }
            // setBusy(false);

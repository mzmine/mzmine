...
int main(int argc, char* argv[]) {
    ...
    for (long curScanNum = firstScanNumber; curScanNum <= lastScanNumber; curScanNum++) {
        ...
        if (strstr(thermoFilterLine, "ms ") == NULL) {
            ...
            switch (varPrecChrg.vt)
            {
                case VT_I1: precursorCharge = varPrecChrg.cVal; break;
                case VT_UI1: precursorCharge = varPrecChrg.bVal; break;
                case VT_I2: precursorCharge = varPrecChrg.iVal; break;
                case VT_UI2: precursorCharge = varPrecChrg.uiVal; break;
                case VT_I4: precursorCharge = varPrecChrg.lVal; break;
                case VT_UI4: precursorCharge = varPrecChrg.ulVal; break;
                case VT_INT: precursorCharge = varPrecChrg.intVal; break;
                case VT_UINT: precursorCharge = varPrecChrg.uintVal; break;
            }

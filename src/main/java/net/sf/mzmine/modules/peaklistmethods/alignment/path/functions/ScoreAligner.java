...
public class ScoreAligner implements Aligner {
        ...
        private List<AlignmentPath> generatePathsThreaded(final ScoreCalculator c, final List<List<PeakListRow>> peaksToUse) throws CancellationException {
        ...
        private ThreadInfo[] calculateIntervals(int threads, int col, List<List<PeakListRow>> listOfPeaks) {
        ...
        private class AlignerThread implements Runnable {
                ...
                private void align() {
                        List<PeakListRow> myList = listOfAllPeaks.get(ti.currentColumn()).subList(ti.startIx(), ti.endIx());

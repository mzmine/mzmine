...
public class PubChemGateway implements DBGateway {
  ...
  public static final String searchURL =
      "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?usehistory=n&db=pccompound&sort=cida&retmax=";
  public static final String compoundURL =
      "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esummary.fcgi?db=pccompound&id=";
  ...
  public DBCompound getCompound(String CID, ParameterSet parameters) throws IOException {
    ...
    try {
      ...
      XPathExpression expr =
          xpath.compile("//eSummaryResult/DocSum/Item[@Name='MeSHHeadingList']/Item");
      ...
      if (nameElement == null) {
        expr = xpath.compile("//eSummaryResult/DocSum/Item[@Name='SynonymList']/Item");
        nameElementNL = (NodeList) expr.evaluate(parsedResult, XPathConstants.NODESET);
        nameElement = (Element) nameElementNL.item(0);
      }

      if (nameElement == null) {
        expr = xpath.compile("//eSummaryResult/DocSum/Item[@Name='IUPACName']");
        nameElementNL = (NodeList) expr.evaluate(parsedResult, XPathConstants.NODESET);
        nameElement = (Element) nameElementNL.item(0);
      }
      ...
      expr = xpath.compile("//eSummaryResult/DocSum/Item[@Name='MolecularFormula']");

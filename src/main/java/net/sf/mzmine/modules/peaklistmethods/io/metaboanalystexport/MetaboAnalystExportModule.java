...
public class MetaboAnalystExportModule implements MZmineProcessingModule {
    ...
    private static final String MODULE_DESCRIPTION = "This method exports the peak list contents into a CSV (comma-separated values) file that is formatted for easy processing by the MetaboAnalyst service (http://www.metaboanalyst.ca).";

...
public class PeakResolverSetupDialog extends ParameterSetupDialog {
     ...
     *            resolver class.
     */
    public PeakResolverSetupDialog(Window parent, boolean valueCheckRequired, final ParameterSet resolverParameters,
	...
	if (preview != null && preview.isSelected()) {
		...
		// just exit.
		if (parameterSet
			.checkParameterValues(new ArrayList<String>(0))) {

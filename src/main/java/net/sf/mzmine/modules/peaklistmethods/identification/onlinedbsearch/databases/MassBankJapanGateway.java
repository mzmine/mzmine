...
public class MassBankJapanGateway implements DBGateway {
    ...
    private static final String instrumentTypes[] = { "APCI-ITFT", "APCI-ITTOF",
		...
		"ESI-QTOF", "FAB-B", "FAB-EB", "FAB-EBEB", "FD-B", "FI-B", "GC-EI-QQ",
		"GC-EI-TOF", "LC-APCI-QTOF", "LC-APPI-QQ", "LC-ESI-IT", "LC-ESI-ITFT",
		"LC-ESI-ITTOF", "LC-ESI-Q", "LC-ESI-QFT", "LC-ESI-QIT", "LC-ESI-QQ",
		"LC-ESI-QTOF", "LC-ESI-TOF", "MALDI-QIT", "MALDI-TOF", "MALDI-TOFTOF" };
	...
	DBCompound newCompound = new DBCompound(OnlineDatabase.MASSBANKJapan, ID,

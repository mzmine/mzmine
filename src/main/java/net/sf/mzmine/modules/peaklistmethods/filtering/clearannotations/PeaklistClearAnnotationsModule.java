...
/**
 * Implements a filter for comparison of peaks in a given row after alignment results. 
 * The filter removes rows (features) that meet certain criteria between given peaks in the row
 * e.g. fold change, etc.
 */
public class PeaklistClearAnnotationsModule implements MZmineProcessingModule {
    ...
    public ExitCode runModule(@Nonnull MZmineProject project,
        ...
        final PeakList[] peakLists = parameters
                .getParameter(PeaklistClearAnnotationsParameters.PEAK_LISTS).getValue()

...
public class GPLipidSearchParameters extends SimpleParameterSet {
  ...
  public static final MultiChoiceParameter<GPLipidType> lipidTypes =
      new MultiChoiceParameter<GPLipidType>("Type of lipids",
          "Selection of glycerophospholipis to consider", GPLipidType.values());

  public static final IntegerParameter minChainLength =
      new IntegerParameter("Minimum fatty acid length", "Minimum length of the fatty acid chain");

  public static final IntegerParameter maxChainLength =
      new IntegerParameter("Maximum fatty acid length", "Maximum length of the fatty acid chain");

  public static final IntegerParameter maxDoubleBonds = new IntegerParameter(
      "Maximum number of double bonds", "Maximum number of double bonds in one fatty acid chain");

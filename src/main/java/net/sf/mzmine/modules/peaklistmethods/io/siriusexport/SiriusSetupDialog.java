...
public class SiriusSetupDialog extends JDialog
implements ActionListener, DocumentListener {
     ...
     * Constructor
     */
    public SiriusSetupDialog(Window parent, boolean valueCheckRequired, ParameterSet parameters) {

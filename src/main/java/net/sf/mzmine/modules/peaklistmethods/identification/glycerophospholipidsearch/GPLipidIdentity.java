...
public class GPLipidIdentity extends SimplePeakIdentity {
  ...
  public GPLipidIdentity(final GPLipidType lipidType, final int fattyAcid1Length,
      final int fattyAcid1DoubleBonds, final int fattyAcid2Length,
      final int fattyAcid2DoubleBonds) {

    this(
        lipidType.getAbbr() + '(' + fattyAcid1Length + ':' + fattyAcid1DoubleBonds + '/'
            + fattyAcid2Length + ':' + fattyAcid2DoubleBonds + ')',

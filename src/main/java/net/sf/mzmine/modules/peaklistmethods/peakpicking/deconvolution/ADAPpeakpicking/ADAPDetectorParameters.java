...
public class ADAPDetectorParameters extends SimpleParameterSet {
  ...
  public static final DoubleNonEmptyRangeParameter PEAK_DURATION =
      new DoubleNonEmptyRangeParameter("Peak duration range", "Range of acceptable peak lengths",
          MZmineCore.getConfiguration().getRTFormat(), true, Range.closed(0.0, 10.0));

  public static final DoubleNonEmptyRangeParameter RT_FOR_CWT_SCALES_DURATION = new DoubleNonEmptyRangeParameter(
      "RT wavelet range",

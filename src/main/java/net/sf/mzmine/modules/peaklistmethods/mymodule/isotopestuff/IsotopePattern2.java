...
public class IsotopePattern2 {
    ...
    private List<String> elementSymbols = new ArrayList<String>();

    /**
     * Constructor of the IsotopePattern object.
     */
    public IsotopePattern2() {

    }
    
    public void addElementSymbol (String element)
    {
    	elementSymbols.add(element);
    }
    
    public String getElementSymbol (int position)
    {
    	return elementSymbols.get(position);
    }
    /**
    ...
    public Object clone() throws CloneNotSupportedException {
        IsotopePattern2 isoClone = new IsotopePattern2();

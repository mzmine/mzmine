...
public class Candidate {
	...
	private int candID; //row represents index in groupedPeaks list, candID is ID in original PeakList
	 ...
	 * @return
	 */
	public boolean checkForBetterRating(PeakListRow parent, PeakListRow candidate, IsotopePattern pattern, int peakNum, double minRating, boolean checkIntensity)
	{
	 ...
	 * @return
	 */
	public boolean checkForBetterRating(DataPoint parent, double candidateIntensity, PeakListRow candidate, IsotopePattern pattern, int peakNum, double minRating, boolean checkIntensity)
	{
		...
		if(checkIntensity)
		{
			intensAcc = calcIntensityAccuracy_Avg(parent.getIntensity(), candidateIntensity, points[0], points[peakNum]);

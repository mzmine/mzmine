 ...
 */
class PointTwoDBottomPanel extends JPanel implements TreeModelListener,
	ActionListener {
    ...
    private PointTwoDVisualizerWindow masterFrame;
    private RawDataFile dataFile;

    PointTwoDBottomPanel(PointTwoDVisualizerWindow masterFrame, RawDataFile dataFile,
	...
	thresholdSettings = parameters
		.getParameter(PointTwoDVisualizerParameters.peakThresholdSettings);

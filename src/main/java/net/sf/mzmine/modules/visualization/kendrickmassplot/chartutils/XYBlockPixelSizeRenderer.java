 ...
 * 09-Feb-2018 : fixed pixel block sizes for plots in MZmine (Ansgar Korf)
 */
...
public class XYBlockPixelSizeRenderer extends AbstractXYItemRenderer
	...
	/**
	 * The anchor point used to align each block to its (x, y) location. The default
	 * value is {@code RectangleAnchor.CENTER}.
	 */
	...
	/**
	 * Returns the anchor point used to align a block at its (x, y) location. The
	 * default values is {@link RectangleAnchor#CENTER}.
	 *
	...
	/**
	 * Sets the anchor point used to align a block at its (x, y) location and sends

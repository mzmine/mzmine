...
/**
 * A renderer that represents data from an {@link XYZDataset} by drawing a color
 * block at each (x, y) point, where the color is a function of the z-value from
 * the dataset. The example shown here is generated by the
 * {@code XYBlockChartDemo1.java} program included in the JFreeChart demo
 * collection: <br>
 * <br>
 * <img src="../../../../../images/XYBlockRendererSample.png" alt=
 * "XYBlockRendererSample.png">
 *
 * @since 1.0.4
 */
public class KendrickMassPlotRenderer extends AbstractXYItemRenderer
     ...
     */
    public KendrickMassPlotRenderer() {
        updateOffsets();
     ...
     *
     * @param width
     *            the new width, in pixel units (must be &gt; 0.0).
     *
     * @see #getBlockWidth()
     */
     ...
     *
     * @param scale
     *            the scale ({@code null} not permitted).
     *
     * @see #getPaintScale()
     * @since 1.0.4
     */
    ...
    public void drawItem(Graphics2D g2, XYItemRendererState state,
        ...
        double xx1 = domainAxis.valueToJava2D(x, dataArea,
                plot.getDomainAxisEdge());
        double yy1 = rangeAxis.valueToJava2D(y, dataArea,
                plot.getRangeAxisEdge());
        Rectangle2D block;
        PlotOrientation orientation = plot.getOrientation();
        if (orientation.equals(PlotOrientation.HORIZONTAL)) {
            block = new Rectangle2D.Double(Math.min(yy0, yy1),
                    Math.min(xx0, xx1), blockWidthPixel, blockHeightPixel);
        } else {
            block = new Rectangle2D.Double(Math.min(xx0, xx1),
                    Math.min(yy0, yy1), blockWidthPixel, blockHeightPixel);
        }
        g2.setPaint(p);
        g2.fill(block);
        ...
        double transY = rangeAxis.valueToJava2D(y, dataArea,
                plot.getRangeAxisEdge());
        updateCrosshairValues(crosshairState, x, y, datasetIndex, transX,
                transY, orientation);
    ...
    /**
     * Tests this {@code XYBlockRenderer} for equality with an arbitrary object.
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof KendrickMassPlotRenderer)) {
            return false;
        }
        KendrickMassPlotRenderer that = (KendrickMassPlotRenderer) obj;
    ...
    public Object clone() throws CloneNotSupportedException {
        KendrickMassPlotRenderer clone = (KendrickMassPlotRenderer) super.clone();

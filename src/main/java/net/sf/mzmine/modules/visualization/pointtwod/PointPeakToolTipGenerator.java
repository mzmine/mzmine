 ...
 */
class PointPeakToolTipGenerator implements XYToolTipGenerator {
	...
	PointPeakDataSet peakDataSet = (PointPeakDataSet) dataset;
	PointPeakDataPoint dataPoint = peakDataSet.getDataPoint(series, item);

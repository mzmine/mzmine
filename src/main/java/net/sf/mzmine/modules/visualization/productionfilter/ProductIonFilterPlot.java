...
class ProductIonFilterPlot extends ChartPanel {
	...
	// crosshair stroke
	private static final BasicStroke crossHairStroke = new BasicStroke(1, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL,
	...
	ProductIonFilterPlot(ProductIonFilterVisualizerWindow visualizer, ProductIonFilterDataSet dataset, Object xAxisType) {

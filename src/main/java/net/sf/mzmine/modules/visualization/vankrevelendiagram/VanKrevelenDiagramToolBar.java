...
public class VanKrevelenDiagramToolBar extends JToolBar {
	...
	public VanKrevelenDiagramToolBar(ActionListener masterFrame) {
		...
		GUIUtils.addButton(this, null, blockSizeIcon, masterFrame, "TOGGLE_BLOCK_SIZE", "Toggle block size");
		...
		GUIUtils.addButton(this, null, backColorIcon, masterFrame, "TOGGLE_GRID", "Toggle grid");

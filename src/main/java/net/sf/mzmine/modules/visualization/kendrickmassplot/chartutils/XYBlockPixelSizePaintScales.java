 ...
 * terms of the GNU General private License as published by the Free Software
...
/**
 * Paint scales for XYZ datasets
 * These scales can be used with the
 * XYBlockRenderer
 * 
...
public class XYBlockPixelSizePaintScales {
	...
	/*
	 * returns an array with rainbow colors with black as lower bound and magenta as
	 * upper bound
	 */
	...
	/*
	 * returns an array with green colors with black as lower bound and magenta as
	 * upper bound
	 */
	...
	/*
	 * returns an array with yellow colors with black as lower bound and magenta as
	 * upper bound
	 */
	...
	/*
	 * returns an array with cyan colors with black as lower bound and magenta as
	 * upper bound
	 */
	 ...
	 */
	public static Paint[] getPaintColors(String zAxisScaleType, Range<Double> zScaleRange, String paintScaleStyle) {
		Paint[] scale = null;

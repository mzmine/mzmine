...
public class KendrickMassPlotParameters extends SimpleParameterSet {
	...
	public static final ComboParameter<String> zAxisValues = new ComboParameter<>("Z-Axis",
			...
			new String[] { "none", "Retention time", "Intensity", "Area", "Tailing factor", "Asymmetry factor", "FWHM",
					"KMD (CH2)", "KMD (H)", "KMD (O)", "m/z" });

	public static final ComboParameter<String> zScaleType = new ComboParameter<>("Z-Axis scale", "Select Z-Axis scale",
			new String[] { "percentile", "custom" });

	public static final DoubleRangeParameter zScaleRange = new DoubleRangeParameter("Range for z-Axis scale",
	...
	public KendrickMassPlotParameters() {
		super(new Parameter[] { peakList, rawFile, selectedRows, yAxisValues, xAxisValues, zAxisValues, zScaleType,

...
public class KendrickMassPlotParameters extends SimpleParameterSet {
    ...
    public static final ComboParameter<String> yAxisValues = new ComboParameter<>(
            "Y-Axis", "Select the kendrick mass defect base",
            new String[] { "KMD (CH2)", "KMD (H)", "KMD (O)" });
    ...
    public static final ComboParameter<String> zAxisValues = new ComboParameter<>(
            ...
            new String[] { "none", "Retention time", "Intensity", "Area",
                    "Tailing factor", "Asymmetry factor", "FWHM", "KMD (CH2)",
                    "KMD (H)", "KMD (O)", "m/z" });

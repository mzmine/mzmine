...
public class ThreeDPropertiesDialog extends JDialog {
  ...
  private JPanel createZAxisPanel() {
    ...
    final JFormattedTextField textField =
        new JFormattedTextField(MZmineCore.getConfiguration().getIntensityFormat());
      ...
      public void propertyChange(final PropertyChangeEvent evt) {
        ...
        if (value != null && !locked) {
          try {
            ...
            // or logarithmic mode.
            slider.setValue((int) ((double) SLIDER_MAX
    ...
    slider.addChangeListener(new ChangeListener() {
      ...
      public void stateChanged(final ChangeEvent e) {
        if (!locked) {
          ...
          final double value =
              display.getUseLog10Intensity() ? StrictMath.pow(10.0, logMax * x) : linMax * x;
    ...
    panel.add(slider, new GridBagConstraints(1, 0, 1, 1, 1.0, 0.0, CENTER, HORIZONTAL,
  ...
  private Component createLabelPanel() {
    ...
    clrButton.addActionListener(new ActionListener() {
      ...
      @Override
      public void actionPerformed(final ActionEvent e) {
        final Color clr = JColorChooser.showDialog(ThreeDPropertiesDialog.this, "Label Color",
    ...
    final JCheckBox checkBox =
        new JCheckBox("Apply opacity map to labels", display.getUseAnnotationAlphaMap());
    checkBox.addActionListener(new ActionListener() {
      @Override
      public void actionPerformed(final ActionEvent e) {
    ...
    if (fontButton != null) {
      panel.add(fontButton,
          new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, CENTER, NONE, EMPTY_INSETS, 0, 0));
    }
    panel.add(clrButton,
        new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0, CENTER, NONE, EMPTY_INSETS, 0, 0));
    panel.add(checkBox,
        new GridBagConstraints(0, 1, 2, 1, 0.0, 0.0, WEST, NONE, EMPTY_INSETS, 0, 0));

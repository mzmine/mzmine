        ...
        private void checkCurrentPeak() {
                ...
                for (int i = 1; i < currentPeakDataPoints.size() - 1; i++) {
                        ...
                        if (rtRange.contains(currentPeakDataPoints.get(i).getRT())) {
                                ...
                                if ((currentPeakDataPoints.get(i).getIntensity() >= currentPeakDataPoints.get(i + 1).getIntensity())
                                        && (currentPeakDataPoints.get(i).getIntensity() >= currentPeakDataPoints.get(i - 1).getIntensity())) {

...
public class GridMassTask extends AbstractTask {
	...
	this.mzTolerance = parameters.getParameter(
		GridMassParameters.mzTolerance).getValue();
	this.mzTol = this.mzTolerance; // .getMzTolerance();
	this.minimumTimeSpan = parameters.getParameter(
		GridMassParameters.minimumTimeSpan).getValue();
	this.maximumTimeSpan = parameters.getParameter(
		GridMassParameters.maximumTimeSpan).getValue();
	...
	this.debug = parameters.getParameter(GridMassParameters.showDebug)
		.getValue();

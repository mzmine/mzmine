 ...
 * 
 */
public class DPPIsotopeGrouperTask_ extends DataPointProcessingTask {

  private static Logger logger = Logger.getLogger(DPPIsotopeGrouperTask_.class.getName());
  ...
  public DPPIsotopeGrouperTask_(DataPoint[] dataPoints, SpectraPlot plot, ParameterSet parameterSet,

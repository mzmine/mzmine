...
public class PeakListImpl extends DataPointStoreImpl implements PeakList {
    ...
    public PeakListImpl(String name, RawDataFile dataFile) {
	this(name, new RawDataFile[] { dataFile });
    }

    public PeakListImpl(String name, RawDataFile[] dataFiles) {
	...
	return getRowsInsideScanAndMZRange(Range.all(), mzRange);
    }

    public PeakListRow[] getRowsInsideScanRange(Range<Double> rtRange) {
	return getRowsInsideScanAndMZRange(rtRange, Range.all());
    }
	...
	return getPeaksInsideScanAndMZRange(file, rtRange, Range.all());
    }
	...
	return getPeaksInsideScanAndMZRange(file, Range.all(), mzRange);
    }

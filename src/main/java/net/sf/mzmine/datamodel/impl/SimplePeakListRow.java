...
public class SimplePeakListRow implements PeakListRow {
	...
	peaks.put(rawData, peak);
        if (preferred) preferredPeak = peak;
    ...
    {
        if (preferredPeak != null && preferredPeak.getIsotopePattern() != null)
            return preferredPeak.getIsotopePattern();
    ...
    {
        if (preferredPeak != null) return preferredPeak;

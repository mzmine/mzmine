 ...
 */
public class IsotopePatternImpl implements IsotopePattern {
   ...
   IsotopePatternImpl(DataPoint dataPoints[],
    ...
    @Override
    public void setDataPoints(DataPoint[] newDataPoints) throws IOException {
	// TODO Auto-generated method stub

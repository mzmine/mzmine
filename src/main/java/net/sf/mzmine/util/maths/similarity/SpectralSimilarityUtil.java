...
public class SpectralSimilarityUtil {
   ...
   */
  @Nullable
  public static SpectraSimilarity createMS2SimWeightedCosine(MZTolerance mzTol, DataPoint[] a,
      DataPoint[] b, double minMatch, Weights weights) {
    // align
    List<DataPoint[]> aligned = ScanAlignment.align(mzTol, b, a);
    // overlapping within mass tolerance

...
public class ComponentToolTipManager extends MouseAdapter implements MouseMotionListener {
  ...
  /**
   * Called when the mouse enters the region of a component. This determines whether the tool tip
   * should be shown.
   * 
  ...
  /**
   * This listener is registered when the tooltip is first registered on a component in order to
   * catch the situation where the tooltip was turned on while the mouse was already within the
   * bounds of the component. This way, the tooltip will be initiated on a mouse-entered or
   * mouse-moved, whichever occurs first. Once the tooltip has been initiated, we can remove this
   * listener and rely solely on mouse-entered to initiate the tooltip.
   */

...
public class MZmineTOCView extends TOCView {
  ...
  public MZmineTOCView(HelpSet hs, String name, String label, MZmineHelpMap hm, JarFile jarFile) {
  ...
  /**
   * Public method that gets a DefaultMutableTreeNode representing the information in this view
   * instance.
   */
   ...
   * 
   * @param tagName The TOC type to create. Valid types are "tocitem". Null or invalid types will
   *        throw an IllegalArgumentException
   * @param atts Attributes of the Item. Valid attributes are "target", "image", and "text". A null
   *        atts is valid and means no attributes

...
public class MZmineHelpMap implements Map {
   ...
   * 
   * @param iden The iden to get the URL for. If iden is null it is treated as an unresolved ID and
   *        will return null.
   ...
   * 
   * The definition of this is up to the implementation of Map. In particular, it may be the same as
   * getIDFromURL().
   * 
   * @param url A URL

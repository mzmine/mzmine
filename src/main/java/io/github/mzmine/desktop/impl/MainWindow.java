...
package io.github.mzmine.desktop.impl;
...
import io.github.mzmine.desktop.preferences.ErrorMail;
import io.github.mzmine.desktop.preferences.ErrorMailSettings;
...
public class MainWindow extends JFrame implements MZmineModule, Desktop, WindowListener {
  ...
  /**
   * @see io.github.mzmine.desktop.Desktop#getSelectedDataFiles()
   */
  @Override
  ...
  /**
   * @see io.github.mzmine.desktop.Desktop#getMainFrame()
   */
  @Override
  ...
  /**
   * @see io.github.mzmine.desktop.Desktop#setStatusBarText(java.lang.String, java.awt.Color)
   */
  @Override

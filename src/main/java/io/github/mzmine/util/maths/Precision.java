...
public class Precision {
     ...
     * @param value
     * @param sig
     * @return A BigDecimal rounded to sig number of significant digits
     *         (figures)
     */
     ...
     * @param value
     * @param sig
     * @return A String of the value rounded to sig number of significant digits
     *         (figures)
     */
    ...
    /**
     * Uses RoundingMode.HALF_UP. If the number of digits exceeds maxLength, the
     * format is changed to scientific notation with E as x10.
     * 
     * @param value
     * @param sig
     * @param mode
    ...
    /**
     * If the number of digits exceeds maxLength, the format is changed to
     ...
     * @param mode
     * @param maxLength
     *            maximum length (number of digits)
     * @return A String of the value rounded to sig number of significant digits
     *         (figures)
     */
    public static String toString(double value, int sig, RoundingMode mode,

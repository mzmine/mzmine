 ...
 */
public class MultipleSelectionComponent<ValueType> extends JPanel
    ...
    public MultipleSelectionComponent(Object multipleValues[]) {
        ...
        for (int i = 0; i < multipleValues.length; i++) {
            ...
            if (numCheckBoxes < 7)
                vertSize += (int) checkBoxes[i].getPreferredSize().getHeight()
                        + 2;
        ...
        selectNoneButton = GUIUtils.addButton(buttonsPanel, "Clear", null,
                this);

 ...
 */
public class MultipleSelectionComponent<ValueType> extends JPanel implements ActionListener {
  ...
  public MultipleSelectionComponent(Object multipleValues[]) {
    ...
    for (int i = 0; i < multipleValues.length; i++) {
      ...
      checkBoxes[i] = new ExtendedCheckBox<Object>(multipleValues[i], false);
    ...
    JScrollPane scrollPane =
        new JScrollPane(checkBoxesPanel, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED,
  ...
  public void setSelectedValues(Object[] values) {
    ...
    for (ExtendedCheckBox<Object> ecb : checkBoxes) {
      ...
      for (Object v : values) {
        ...
        if ((v == ecb.getObject()) || (v.toString().equals(ecb.getObject().toString())))
          isSelected = true;
      }

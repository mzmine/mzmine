...
/**
 * @description Wrap a Logger as a PrintStream. Useful mainly for porting code
 *              that previously logged to a System PrintStream or to a proxy.
 *              Calling LoggerStream.println() will call Logger.info() for
 *              Level.INFO. A call to flush() or to a println() method will
 *              flush previously written text, and complete a call to Logger.
 *              You may be surprised by extra newlines, if you call print("\n")
...
public class LoggerStream extends PrintStream {
     ...
     * 
     * @param logger
     *            Everything written to this PrintStream will be passed to the
     *            appropriate method of the Logger
     * @param level

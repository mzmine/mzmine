...
public class GUIUtils {
    ...
    public static void registerKeyHandler(JComponent component,
        ...
        registerKeyHandler(component, JComponent.WHEN_IN_FOCUSED_WINDOW, stroke,
     ...
     *            Action command string
     */
    public static void registerKeyHandler(JComponent component, int condition,
            KeyStroke stroke, final ActionListener listener,
            final String actionCommand) {
    ...
    public static JMenuItem addMenuItem(Container menu, String text,
        ...
        return addMenuItem(menu, text, listener, null, mnemonic,
                setAccelerator);
    }
    ...
    public static JMenuItem addMenuItem(Container menu, String text,
        ...
        if (setAccelerator)
            item.setAccelerator(
                    KeyStroke.getKeyStroke(mnemonic, ActionEvent.CTRL_MASK));
        if (menu != null)
            menu.add(item);
        return item;
    }
     ...
     * 
     * @param container
     *            Component to add the checkbox to
     * @param text
     *            Checkbox' text
     * @param icon
     *            Checkbox' icon or null
     * @param listener
     *            Checkbox' listener or null
     * @param actionCommand
     *            Checkbox' action command or null
     * @param mnemonic
     *            Checkbox' mnemonic (virtual key code) or 0
     * @param toolTip
     *            Checkbox' tool tip or null
     * @param state
     *            Checkbox' state
    ...
    public static JCheckBox addCheckbox(Container component, String text,
            ...
            int mnemonic, String toolTip, boolean state) {
    ...
    public static JCheckBox addCheckbox(Container component, String text,
        ...
        return addCheckbox(component, text, icon, listener, actionCommand, 0,
                toolTip, state);
    }
    ...
    public static JCheckBox addCheckbox(Container component, String text,
            ActionListener listener, String actionCommand, String toolTip) {
        return addCheckbox(component, text, null, listener, actionCommand, 0,
                toolTip, false);
    }

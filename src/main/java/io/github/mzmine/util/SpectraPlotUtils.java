...
public class SpectraPlotUtils {
     ...
     * 
     * @param plot
     *            Plot to apply this method to.
     * @param ignore
     *            List of class objects of the instances to ignore.
     */
    public static void clearDatasetLabelGenerators(SpectraPlot plot,
        ...
        for (int i = 0; i < plot.getXYPlot().getDatasetCount(); i++) {
            ...
            if (remove)
                plot.getXYPlot().getRendererForDataset(dataset)
                        .setDefaultItemLabelGenerator(null);
        }
    }
     ...
     *            Plot to apply this method to.
     * @param ignore
     *            Class object of the instances to ignore.
     */
    public static void clearDatasetLabelGenerators(SpectraPlot plot,

...
public class SpectralDBFeatureIdentity extends SimpleFeatureIdentity {
  ...
  public SpectralDBFeatureIdentity(Scan queryScan, SpectralDBEntry entry,
    ...
    super(MessageFormat
            .format("{0} as {3} ({1}) {2} cos={4}", entry.getField(DBEntryField.NAME).orElse("NONAME"),
                // Name
  ...
  public static SpectralDBFeatureIdentity loadFromXML(XMLStreamReader reader,
    ...
    while (reader.hasNext() && !(reader.isEndElement() && reader.getLocalName()
      ...
      switch (reader.getLocalName()) {
        ...
        case SimpleFeatureIdentity.XML_PROPERTIES_ELEMENT -> map = SimpleFeatureIdentity.readPropertyValues(reader);
    ...
    SpectralDBFeatureIdentity id = new SpectralDBFeatureIdentity(scan, entry,
        similarity, map.get(FeatureIdentity.PROPERTY_METHOD));
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(getEntry(), that.getEntry()) && Objects
        .equals(getSimilarity(), that.getSimilarity()) /*&& Objects
        .equals(getQueryScan(), that.getQueryScan())*/;
  }

  @Override
  public int hashCode() {
    return Objects.hash(getEntry(), getSimilarity(), getQueryScan());
  }
}

...
public enum DBEntryField {
  ...
  public String getNistMspID() {
    return switch (this) {
      ...
      case CCS -> "CCS";
      case ACQUISITION, MONA_ID, CHEMSPIDER, RESOLUTION, SYNONYM, MOLWEIGHT, PUBCHEM, SMILES, PUBMED, PRINCIPAL_INVESTIGATOR, CHARGE, CAS, SOFTWARE, INCHI, DATA_COLLECTOR -> "";
    };
  }

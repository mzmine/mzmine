...
public enum DBEntryField {
    ...
    ENTRY_ID, NAME, SYNONYM, COMMENT, ION_TYPE, RT(Double.class), MZ(
            Double.class), CHARGE(
                    Integer.class), ION_MODE, COLLISION_ENERGY, FORMULA, MOLWEIGHT(
    ...
    public static final DBEntryField[] OTHER_FIELDS = new DBEntryField[] {
            PRINCIPAL_INVESTIGATOR, DATA_COLLECTOR, ENTRY_ID, COMMENT };
    public static final DBEntryField[] DATABASE_FIELDS = new DBEntryField[] {
            PUBMED, PUBCHEM, MONA_ID, CHEMSPIDER, CAS };
    public static final DBEntryField[] COMPOUND_FIELDS = new DBEntryField[] {
            NAME, SYNONYM, FORMULA, MOLWEIGHT, EXACT_MASS, ION_TYPE, MZ, CHARGE,
            RT, ION_MODE, INCHI, INCHIKEY, SMILES, NUM_PEAKS };
    public static final DBEntryField[] INSTRUMENT_FIELDS = new DBEntryField[] {
            INSTRUMENT_TYPE, INSTRUMENT, ION_SOURCE, RESOLUTION, MS_LEVEL,
            COLLISION_ENERGY, ACQUISITION, SOFTWARE };
    ...
    public String toString() {
        ...
        default:
            return StringUtils.capitalize(
                    super.toString().replace('_', ' ').toLowerCase());
        }
    }

...
public class Weights {
     ...
     * m/z weight is usually higher for GC-EI-MS (higher m/z -> significant
     * fragments) and lower for LC-MS
     */
    ...
    public static final Weights[] VALUES = new Weights[] { NONE, MASSBANK,
            NIST11, NIST_GC };
    ...
    public String toString() {
        return MessageFormat.format("{0} (mz^{1} * I^{2})", name, mz,
                intensity);
    }
}

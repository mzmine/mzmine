...
/**
 * Class of features types: Provides formatters. Should be added to one {@link ModularDataModel}
 * 
...
public abstract class DataType<T extends Property<?>> {
  ...
  /**
   * The header string (name) of this features type
   * 
   * @return
   */
  @Nonnull
   ...
   * 
   * @param raw null if this is a FeatureListRow column. For Feature columns: the raw features file

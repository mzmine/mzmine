...
public interface FeatureList {
  ...
  /**
   * Returns number of raw features files participating in the feature list
   */
  public int getNumberOfRawDataFiles();

  /**
   * Returns all raw features files participating in the feature list
   */
  ...
  /**
   * Returns a raw features file
   * 
   * @param position Position of the raw features file in the matrix (running numbering from left
   *        0,1,2,...)
   */
  ...
  /**
   * Returns the feature of a given raw features file on a give row of the feature list
   * 
   * @param row Row of the feature list
   * @param rawDataFile Raw features file where the feature is detected/estimated
   */
  public Feature getFeature(int row, RawDataFile rawDataFile);

  /**
   * Returns all features for a raw features file
   */
  ...
  /**
   * Returns maximum raw features point intensity among all features in this feature list
   * 

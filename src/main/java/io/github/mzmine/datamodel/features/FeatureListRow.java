...
public interface FeatureListRow {
  ...
  /**
   * Return raw features with features on this row
   */
  ...
  /**
   * Returns feature for given raw features file
   */
  ...
  /**
   * Returns maximum raw features point intensity among all features in this row
   *

...
public class ModularFeatureList implements FeatureList {
  ...
  /**
   * Returns number of raw features files participating in the alignment
   */
  @Override
  ...
  /**
   * Returns all raw features files participating in the alignment
   * @return
   */
  @Override
  ...
  /**
   * Returns the feature of a given raw features file on a give row of the alignment result
   * 
   * @param row Row of the alignment result
   * @param raw Raw features file where the feature is detected/estimated
   */
  @Override

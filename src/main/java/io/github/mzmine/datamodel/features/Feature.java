...
public interface Feature {
  ...
  /**
   * Returns raw features file where this feature is present
   */
  @Nonnull
   ...
   * not need to match any actual raw features point. May return null, if there is no features point in
   * given scan.
   */
  @Nullable
  ...
  /**
   * Returns all features points.
   */
  ObservableList<DataPoint> getDataPoints();

  /**
   * Returns the retention time range of all raw features points used to detect this feature
   */
  @Nonnull
  Range<Float> getRawDataPointsRTRange();

  /**
   * Returns the range of m/z values of all raw features points used to detect this feature
   */
  @Nonnull
  Range<Double> getRawDataPointsMZRange();

  /**
   * Returns the range of intensity values of all raw features points used to detect this feature
   */
  @Nonnull

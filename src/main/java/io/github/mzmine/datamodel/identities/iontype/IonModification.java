...
public class IonModification extends NeutralMolecule
        implements Comparable<IonModification> {

    // use combinations of X adducts (2H++; -H+Na2+) and modifications
    public static final IonModification M_MINUS = new IonModification(
            IonModificationType.ADDUCT, "e", +0.00054858, -1);
    public static final IonModification H_NEG = new IonModification(
            IonModificationType.ADDUCT, "H", "H", -1.007276, -1);
    public static final IonModification M_PLUS = new IonModification(
            IonModificationType.ADDUCT, "e", -0.00054858, 1);
    public static final IonModification H = new IonModification(
            IonModificationType.ADDUCT, "H", "H", 1.007276, 1);
    //
    public static final IonModification NA = new IonModification(
            IonModificationType.ADDUCT, "Na", "Na", 22.989218, 1, 1);
    public static final IonModification NH4 = new IonModification(
            IonModificationType.ADDUCT, "NH4", "NH4", 18.033823, 1);
    public static final IonModification K = new IonModification(
            IonModificationType.ADDUCT, "K", "K", 38.963158, 1, 1);
    public static final IonModification FE = new IonModification(
            IonModificationType.ADDUCT, "Fe", "Fe", 55.933840, 2, 1);
    public static final IonModification CA = new IonModification(
            IonModificationType.ADDUCT, "Ca", "Ca", 39.961493820, 2, 1);
    public static final IonModification MG = new IonModification(
            IonModificationType.ADDUCT, "Mg", "Mg", 47.96953482, 2, 1);
    // combined
    public static final IonModification H2plus = new CombinedIonModification(
            new IonModification[] { H, H });
    public static final IonModification NA_H = new CombinedIonModification(
            new IonModification[] { NA, H });
    public static final IonModification K_H = new CombinedIonModification(
            new IonModification[] { K, H });
    public static final IonModification NH4_H = new CombinedIonModification(
            new IonModification[] { NH4, H });
    public static final IonModification Hneg_NA2 = new CombinedIonModification(
            new IonModification[] { NA, NA, H_NEG });
    public static final IonModification Hneg_CA = new CombinedIonModification(
            new IonModification[] { CA, H_NEG });
    public static final IonModification Hneg_FE = new CombinedIonModification(
            new IonModification[] { FE, H_NEG });
    public static final IonModification Hneg_MG = new CombinedIonModification(
            new IonModification[] { MG, H_NEG });

    // NEGATIVE
    public static final IonModification CL = new IonModification(
            IonModificationType.ADDUCT, "Cl", "Cl", 34.969401, -1);
    public static final IonModification BR = new IonModification(
            IonModificationType.ADDUCT, "Br", "Br", 78.918886, -1);
    public static final IonModification FA = new IonModification(
            IonModificationType.ADDUCT, "FA", "HCO2", 44.99820285, -1);
    // combined
    // +Na -2H+]-
    public static final IonModification NA_2H = new CombinedIonModification(
            new IonModification[] { NA, H_NEG, H_NEG });

    // modifications
    public static final IonModification H2 = new IonModification(
            IonModificationType.NEUTRAL_LOSS, "H2", "H2", -2.015650, 0);
    public static final IonModification C2H4 = new IonModification(
            IonModificationType.NEUTRAL_LOSS, "C2H4", "C2H4", -28.031301, 0);
    public static final IonModification H2O = new IonModification(
            IonModificationType.NEUTRAL_LOSS, "H2O", "H2O", -18.010565, 0);
    public static final IonModification H2O_2 = new CombinedIonModification(
            new IonModification[] { H2O, H2O });

    public static final IonModification NH3 = new IonModification(
            IonModificationType.NEUTRAL_LOSS, "NH3", "NH3", -17.026549, 0);
    public static final IonModification CO = new IonModification(
            IonModificationType.NEUTRAL_LOSS, "CO", "CO", -27.994915, 0);
    public static final IonModification CO2 = new IonModification(
            IonModificationType.NEUTRAL_LOSS, "CO2", "CO2", -43.989829, 0);
    // cluster
    public static final IonModification MEOH = new IonModification(
            IonModificationType.CLUSTER, "MeOH", "CH3OH", 32.026215, 0);
    public static final IonModification HFA = new IonModification(
            IonModificationType.CLUSTER, "HFA", "CHOOH", 46.005479, 0);
    public static final IonModification HAc = new IonModification(
            IonModificationType.CLUSTER, "HAc", "CH3COOH", 60.021129, 0);
    public static final IonModification ACN = new IonModification(
            IonModificationType.CLUSTER, "ACN", "CH3CN", 41.026549, 0);
    public static final IonModification O = new IonModification(
            IonModificationType.CLUSTER, "O", "O", 15.99491462, 0);
    public static final IonModification ISOPROP = new IonModification(
            IonModificationType.CLUSTER, "IsoProp", "C3H8O", 60.058064, 0);
    // isotopes
    public static final IonModification C13 = new IonModification(
            IonModificationType.ISOTOPE, "(13C)", 1.003354838, 0);

    // default values
    public static final IonModification[] DEFAULT_VALUES_POSITIVE = { H_NEG,
            M_PLUS, H, NA, K, NH4, H2plus, CA, FE, MG, NA_H, NH4_H, K_H,
            Hneg_NA2, Hneg_CA, Hneg_FE, Hneg_MG };
    public static final IonModification[] DEFAULT_VALUES_NEGATIVE = { M_MINUS,
            H_NEG, NA_2H, NA, CL, BR, FA };
    // default modifications
    public static final IonModification[] DEFAULT_VALUES_MODIFICATIONS = { H2O,
            H2O_2, NH3, O, CO, CO2, C2H4, HFA, HAc, MEOH, ACN, ISOPROP };
    // isotopes
     ...
     *            mass difference (for single charge, Molecule) for example M to
     *            M+H+ (1.0072) M to M+Na+ (22.9892)
     * @param charge
     *            negative for negatives
     * @param molecules
     *            count of molecules in a cluster
     */
    /**
     * copy of adduct
     * 
    ...
    public IonModification(IonModification a) {
        this(a.type, a.getName(), a.getMolFormula(), a.getMass(),
                a.getCharge());
    }
     ...
     * @param molecules
     */
    public IonModification(IonModificationType type, String name,
            String molFormula, double massDifference, int charge) {
    ...
    public String getMassDiffString() {
        return MZmineCore.getConfiguration().getMZFormat().format(mass)
                + " m/z";
    }
    ...
    public boolean uniqueAdductsTo(IonModification adduct) {
        ...
        return Arrays.stream(a).noneMatch(
                adda -> Arrays.stream(b).anyMatch(addb -> adda.equals(addb)));
    }
    ...
    public static IonModification[] getDefaultValuesPos() {
        return Arrays.copyOf(DEFAULT_VALUES_POSITIVE,
                DEFAULT_VALUES_POSITIVE.length);
    }

    public static IonModification[] getDefaultValuesNeg() {
        return Arrays.copyOf(DEFAULT_VALUES_NEGATIVE,
                DEFAULT_VALUES_NEGATIVE.length);
    }

    public static IonModification[] getDefaultModifications() {
        return Arrays.copyOf(DEFAULT_VALUES_MODIFICATIONS,
                DEFAULT_VALUES_MODIFICATIONS.length);
    }

    public static IonModification[] getDefaultIsotopes() {
        return Arrays.copyOf(DEFAULT_VALUES_MODIFICATIONS,
                DEFAULT_VALUES_ISOTOPES.length);
    }
    ...
    public static IonModification getUndefinedforCharge(int charge) {
        ...
        return new IonModification(IonModificationType.UNDEFINED_ADDUCT, "?",
                mass, charge);
    }

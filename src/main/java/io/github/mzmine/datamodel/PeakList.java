...
public interface PeakList {
    ...
    /**
     * Returns the peak of a given raw data file on a give row of the feature
     * list
     * 
     * @param row
     *            Row of the feature list
     * @param rawDataFile
    ...
    /**
     * Returns maximum raw data point intensity among all peaks in this feature
     * list
     * 

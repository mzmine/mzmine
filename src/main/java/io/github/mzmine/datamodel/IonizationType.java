...
public enum IonizationType {
  ...
  NAME2("[M]3+","+3",-0.001645737,PolarityType.POSITIVE,-3.51290442213519,1,3),//

  NAME3("[M]2+","+2",-0.0010404,PolarityType.POSITIVE,-3.51290442213519,1,2),//
  ...
  NAME_7("[M-2H]-","+1",-2.01506,PolarityType.NEGATIVE,-2.77090108169269,1,-1),//

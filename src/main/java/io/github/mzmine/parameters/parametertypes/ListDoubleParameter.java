...
public class ListDoubleParameter
        implements UserParameter<List<Double>, ListDoubleComponent>

{
    ...
    public ListDoubleParameter cloneParameter() {
        ListDoubleParameter copy = new ListDoubleParameter(name, description,
                valueRequired, value);
        copy.setValue(value);
        return copy;
    }

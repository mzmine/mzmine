...
public class LipidModificationChoiceParameter
        extends MultiChoiceParameter<LipidModification> {
    /**
    ...
    public LipidModificationChoiceParameter cloneParameter() {
        ...
        final LipidModificationChoiceParameter copy = new LipidModificationChoiceParameter(
                getName(), getDescription(), getChoices(), getChoices().length);

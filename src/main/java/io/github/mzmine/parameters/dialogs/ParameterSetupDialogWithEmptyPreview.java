...
/**
 * You can extend this class to create your own setup dialog containing a
 * preview. All you need to do is extend this, call super.addDialogComponents();
 * in the extention's addDialogComponents(); and then add your preview (e.g. a
 * chart) to pnlPreview via the .add-method to BorderLayout.CENTER. If you need
 * extra buttons you can add them to pnlPreviewButtons, which is a panel south
 * of the preview and formatted by a flow layout.
 * 
 * Please note the mainPanel of ParameterSetupDialog is not the main panel
 * anymore, but newMainPanel is. The old mainPanel is moved inside a JScrollPane
 * to allow users with low resolution to set the parameters properly.
 * 
 * TODO: COPY actionPerformed METHOD TO YOUR SUBCLASS AND UNCOMMENT THE LINES TO
 * SHOW PREVIEW DEFINE cmpPreview AS WELL. THIS IS PRECODED FOR A CHECKBOX!
 * 
...
public class ParameterSetupDialogWithEmptyPreview extends ParameterSetupDialog {
    ...
    protected JPanel pnlParameters; // this will contain all parameters of the
                                    // module (the main panel
    // will be inserted here)

    public ParameterSetupDialogWithEmptyPreview(Window parent,
    ...
    protected void addDialogComponents() {
        ...
        pnScroll.setVerticalScrollBarPolicy(
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        /*
         * if (ae.getSource() == cmpPreview) {
         * logger.info(ae.getSource().toString());
         * 
         * if (cmpPreview.isSelected()) { newMainPanel.add(pnlPreview,
         * BorderLayout.CENTER); pnlPreview.setVisible(true);
         * updateMinimumSize(); pack(); } else {
         * newMainPanel.remove(pnlPreview); pnlPreview.setVisible(false);

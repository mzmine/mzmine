 ...
 */
public abstract class ParameterSetupDialogWithScanPreview
        extends ParameterSetupDialog {
    ...
    protected void addDialogComponents() {
        ...
        spectrumPlot.setBorder(
                BorderFactory.createEtchedBorder(EtchedBorder.RAISED));
        spectrumPlot.setMinimumSize(new Dimension(400, 300));

        mainPanel.add(pnlPreviewFields, 0, getNumberOfParameters() + 3, 3, 1, 0,
                0);

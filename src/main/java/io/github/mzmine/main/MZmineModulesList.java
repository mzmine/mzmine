...
import io.github.mzmine.modules.dataprocessing.alignment_adap3.ADAP3AlignerModule;
import io.github.mzmine.modules.dataprocessing.alignment_hierarchical.HierarAlignerGcModule;
import io.github.mzmine.modules.dataprocessing.alignment_join.JoinAlignerModule;
import io.github.mzmine.modules.dataprocessing.alignment_ransac.RansacAlignerModule;
import io.github.mzmine.modules.dataprocessing.featuredetection_ADAPchromatogrambuilder.ADAPChromatogramBuilderModule;
import io.github.mzmine.modules.dataprocessing.featuredetection_adap3decompositionV1_5.ADAP3DecompositionV1_5Module;
import io.github.mzmine.modules.dataprocessing.featuredetection_adap3decompositionV2.ADAP3DecompositionV2Module;
import io.github.mzmine.modules.dataprocessing.featuredetection_chromatogrambuilder.ChromatogramBuilderModule;
import io.github.mzmine.modules.dataprocessing.featuredetection_chromatogramdeconvolution.DeconvolutionModule;
import io.github.mzmine.modules.dataprocessing.featuredetection_deisotoper.IsotopeGrouperModule;
import io.github.mzmine.modules.dataprocessing.featuredetection_gridmass.GridMassModule;
...
import io.github.mzmine.modules.dataprocessing.featuredetection_massdetection.MassDetectionModule;
import io.github.mzmine.modules.dataprocessing.featuredetection_msms.MsMsPeakPickerModule;
import io.github.mzmine.modules.dataprocessing.featuredetection_peakextender.PeakExtenderModule;
import io.github.mzmine.modules.dataprocessing.featuredetection_shapemodeler.ShapeModelerModule;
import io.github.mzmine.modules.dataprocessing.featuredetection_shoulderpeaksfilter.ShoulderPeaksFilterModule;
import io.github.mzmine.modules.dataprocessing.featuredetection_smoothing.SmoothingModule;
import io.github.mzmine.modules.dataprocessing.featuredetection_targeted.TargetedPeakDetectionModule;
import io.github.mzmine.modules.dataprocessing.filtering_alignscans.AlignScansModule;
import io.github.mzmine.modules.dataprocessing.filtering_baselinecorrection.BaselineCorrectionModule;
import io.github.mzmine.modules.dataprocessing.filtering_clearannotations.PeaklistClearAnnotationsModule;
import io.github.mzmine.modules.dataprocessing.filtering_cropfilter.CropFilterModule;
import io.github.mzmine.modules.dataprocessing.filtering_duplicatefilter.DuplicateFilterModule;
import io.github.mzmine.modules.dataprocessing.filtering_extractscans.ExtractScansModule;
import io.github.mzmine.modules.dataprocessing.filtering_groupms2.GroupMS2Module;
import io.github.mzmine.modules.dataprocessing.filtering_merge.RawFileMergeModule;
import io.github.mzmine.modules.dataprocessing.filtering_neutralloss.NeutralLossFilterModule;
import io.github.mzmine.modules.dataprocessing.filtering_peakcomparisonrowfilter.PeakComparisonRowFilterModule;
import io.github.mzmine.modules.dataprocessing.filtering_peakfilter.PeakFilterModule;
import io.github.mzmine.modules.dataprocessing.filtering_rowsfilter.RowsFilterModule;
import io.github.mzmine.modules.dataprocessing.filtering_scanfilters.ScanFiltersModule;
import io.github.mzmine.modules.dataprocessing.filtering_scansmoothing.ScanSmoothingModule;
import io.github.mzmine.modules.dataprocessing.gapfilling_peakfinder.PeakFinderModule;
import io.github.mzmine.modules.dataprocessing.gapfilling_peakfinder.multithreaded.MultiThreadPeakFinderModule;
import io.github.mzmine.modules.dataprocessing.gapfilling_samerange.SameRangeGapFillerModule;
...
import io.github.mzmine.modules.dataprocessing.normalization_linear.LinearNormalizerModule;
import io.github.mzmine.modules.dataprocessing.normalization_rtcalibration.RTCalibrationModule;
import io.github.mzmine.modules.dataprocessing.normalization_standardcompound.StandardCompoundNormalizerModule;

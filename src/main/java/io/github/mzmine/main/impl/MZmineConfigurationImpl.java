...
public class MZmineConfigurationImpl implements MZmineConfiguration {
    ...
    public Vision getColorVision() {
        return preferences.getParameter(MZminePreferences.colorPalettes)
                .getValue();
    }
    ...
    public void saveConfiguration(File file) throws IOException {
        try {
            ...
            final boolean skipSensitive = !file
                    .equals(MZmineConfiguration.CONFIG_FILE);
            ...
            Element lastFilesElement = configuration
                    .createElement("lastprojects");
            ...
            final SimpleParameterSet encSet = new SimpleParameterSet(
                    new Parameter[] { globalEncrypter });
            ...
            if ((!skipSensitive) && (System.getProperty("os.name").toLowerCase()
                    .contains("windows"))) {

...
package io.github.mzmine.modules.io.import_mzml_jmzml;
 ...
 */
public class MzMLImportModule implements MZmineProcessingModule {

  private Logger logger = Logger.getLogger(this.getClass().getName());

  private static final String MODULE_NAME = "mzML file import via jmzml";
  ...
  public @Nonnull Class<? extends ParameterSet> getParameterSetClass() {
    return MzMLImportParameters.class;
  }

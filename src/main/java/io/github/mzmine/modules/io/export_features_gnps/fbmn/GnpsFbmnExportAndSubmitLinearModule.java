 ...
 */
public class GnpsFbmnExportAndSubmitLinearModule implements MZmineProcessingModule {

  private static final String MODULE_NAME = "Export/Submit to GNPS-FBMN (Linear)";
  ...
  public ExitCode runModule(MZmineProject project, ParameterSet parameters, Collection<Task> tasks,
    ...
    GnpsFbmnExportAndSubmitLinearTask task = new GnpsFbmnExportAndSubmitLinearTask(parameters,
        moduleCallDate);
    tasks.add(task);

...
package io.github.mzmine.modules.io.projectload.version_2_0;
...
public class PeakListOpenHandler_2_0 extends DefaultHandler
    ...
    public PeakListOpenHandler_2_0(
    ...
    public void startElement(String namespaceURI, String lName, String qName,
        ...
        if (qName.equals(PeakListElementName_2_0.PEAK.getElementName())) {
            ...
            peakColumnID = attrs
                    .getValue(PeakListElementName_2_0.COLUMN.getElementName());
            mass = Double.parseDouble(attrs
                    .getValue(PeakListElementName_2_0.MZ.getElementName()));
            ...
            rt = Double.parseDouble(
                    attrs.getValue(PeakListElementName_2_0.RT.getElementName()))
                    / 60d;
            ...
            String chargeString = attrs
                    .getValue(PeakListElementName_2_0.CHARGE.getElementName());
        ...
        if (qName.equals(PeakListElementName_2_0.MZPEAKS.getElementName())) {
            numOfMZpeaks = Integer.parseInt(attrs.getValue(
                    PeakListElementName_2_0.QUANTITY.getElementName()));
        }

        // <ISOTOPE_PATTERN>
        if (qName.equals(
                PeakListElementName_2_0.ISOTOPE_PATTERN.getElementName())) {
            ...
            currentIsotopePatternDescription = attrs.getValue(
                    PeakListElementName_2_0.DESCRIPTION.getElementName());
        }
    ...
    public void endElement(String namespaceURI, String sName, String qName)
        ...
        // <NAME>
        if (qName.equals(
                PeakListElementName_2_0.PEAKLIST_NAME.getElementName())) {
        ...
        // <PEAKLIST_DATE>
        if (qName.equals(
                PeakListElementName_2_0.PEAKLIST_DATE.getElementName())) {
        ...
        // <REPRESENTATIVE_SCAN>
        if (qName.equals(
                PeakListElementName_2_0.REPRESENTATIVE_SCAN.getElementName())) {
        ...
        if (qName.equals(
                PeakListElementName_2_0.FRAGMENT_SCAN.getElementName())) {
        ...
        if (qName
                .equals(PeakListElementName_2_0.METHOD_NAME.getElementName())) {
            String appliedMethod = getTextOfElement();
            appliedMethods.add(appliedMethod);
        }

        if (qName.equals(
                PeakListElementName_2_0.METHOD_PARAMETERS.getElementName())) {

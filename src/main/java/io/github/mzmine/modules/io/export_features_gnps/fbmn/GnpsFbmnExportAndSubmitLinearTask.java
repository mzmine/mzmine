 ...
 */
public class GnpsFbmnExportAndSubmitLinearTask extends AbstractTask {

  // Logger.
  private static final Logger logger = Logger.getLogger(
      GnpsFbmnExportAndSubmitLinearTask.class.getName());
  ...
  GnpsFbmnExportAndSubmitLinearTask(ParameterSet parameters, @NotNull Instant moduleCallDate) {

...
public class UserParameterOpenHandler_2_5 extends DefaultHandler
    ...
    public UserParameterOpenHandler_2_5(MZmineProject newProject,
    ...
    public void startElement(String namespaceURI, String lName, String qName,
        ...
        // <PARAMETERS>
        if (qName.equals(
                UserParameterElementName_2_5.PARAMETERS.getElementName())) {
            String count = attrs.getValue(
                    UserParameterElementName_2_5.COUNT.getElementName());
            totalParams = Integer.parseInt(count);
        }

        // <PARAMETER>
        if (qName.equals(
                UserParameterElementName_2_5.PARAMETER.getElementName())) {

            String name = attrs.getValue(
                    UserParameterElementName_2_5.NAME.getElementName());
            String type = attrs.getValue(
                    UserParameterElementName_2_5.TYPE.getElementName());
        ...
        if (qName.equals(UserParameterElementName_2_5.VALUE.getElementName())) {
            currentDataFileID = attrs.getValue(
                    UserParameterElementName_2_5.DATA_FILE.getElementName());
        }
    ...
    public void endElement(String namespaceURI, String sName, String qName)
        ...
        // <OPTION>
        if (qName
                .equals(UserParameterElementName_2_5.OPTION.getElementName())) {

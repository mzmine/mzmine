...
public class RawDataFileOpenHandler_3_0_old extends DefaultHandler {
  ...
  public void startElement(String namespaceURI, String lName, String qName, Attributes attrs)
    ...
    if (qName.equals(RawDataElementName_3_0_old.SCAN.getElementName())) {
      currentStorageID = Integer
          .parseInt(attrs.getValue(RawDataElementName_3_0_old.STORAGE_ID.getElementName()));
    }

    if (qName.equals(RawDataElementName_3_0_old.STORED_DATA.getElementName())) {
      storedDataID = Integer
          .parseInt(attrs.getValue(RawDataElementName_3_0_old.STORAGE_ID.getElementName()));
      storedDataNumDP = Integer
          .parseInt(attrs.getValue(RawDataElementName_3_0_old.QUANTITY_DATAPOINTS.getElementName()));
    }

    if (qName.equals(RawDataElementName_3_0_old.MASS_LIST.getElementName())) {
      String name = attrs.getValue(RawDataElementName_3_0_old.NAME.getElementName());
      int storageID = Integer
          .parseInt(attrs.getValue(RawDataElementName_3_0_old.STORAGE_ID.getElementName()));
//      massList = new SimpleMassList(null, null, null, null);
    }

    if (qName.equals(RawDataElementName_3_0_old.FRAME.getElementName())) {
      currentStorageID = Integer
          .parseInt(attrs.getValue(RawDataElementName_3_0_old.STORAGE_ID.getElementName()));
    }

    if (qName.equals(RawDataElementName_3_0_old.QUANTITY_MOBILITY_SCANS.getElementName())) {
      numberMoblityScans = Integer
          .parseInt(attrs.getValue(RawDataElementName_3_0_old.QUANTITY.getElementName()));
  ...
  public void endElement(String namespaceURI, String sName, String qName) throws SAXException {
    ...
    // <NAME>
    if (qName.equals(RawDataElementName_3_0_old.NAME.getElementName())) {
    ...
    if (qName.equals(RawDataElementName_3_0_old.QUANTITY_SCAN.getElementName())) {
      // number of scans - actually not used for anything
      Integer.parseInt(getTextOfElement());
    }

    if (qName.equals(RawDataElementName_3_0_old.SCAN_ID.getElementName())) {
      scanNumber = Integer.parseInt(getTextOfElement());
    }

    if (qName.equals(RawDataElementName_3_0_old.COLOR.getElementName())) {
    ...
    if (qName.equals(RawDataElementName_3_0_old.MS_LEVEL.getElementName())) {
      msLevel = Integer.parseInt(getTextOfElement());
    }

    if (qName.equals(RawDataElementName_3_0_old.PARENT_SCAN.getElementName())) {
      Integer.parseInt(getTextOfElement());
    }

    if (qName.equals(RawDataElementName_3_0_old.POLARITY.getElementName())) {
    ...
    if (qName.equals(RawDataElementName_3_0_old.SCAN_DESCRIPTION.getElementName())) {
      scanDescription = getTextOfElement();
    }

    if (qName.equals(RawDataElementName_3_0_old.SCAN_MZ_RANGE.getElementName())) {
      final String text = getTextOfElement();
      scanMZRange = RangeUtils.parseDoubleRange(text);
    }

    if (qName.equals(RawDataElementName_3_0_old.PRECURSOR_CHARGE.getElementName())) {
      precursorCharge = Integer.parseInt(getTextOfElement());
    }

    if (qName.equals(RawDataElementName_3_0_old.PRECURSOR_MZ.getElementName())) {
      precursorMZ = Double.parseDouble(getTextOfElement());
    }

    if (qName.equals(RawDataElementName_3_0_old.RETENTION_TIME.getElementName())) {
    ...
    if (qName.equals(RawDataElementName_3_0_old.QUANTITY_DATAPOINTS.getElementName())) {
    ...
    if (qName.equals(RawDataElementName_3_0_old.MOBILITY.getElementName())) {
      mobility = Double.parseDouble(getTextOfElement());
    }

    if (qName.equals(RawDataElementName_3_0_old.MOBILITY_TYPE.getElementName())) {
      mobilityType = MobilityType.valueOf(getTextOfElement());
      mobilityType = (mobilityType == null) ? MobilityType.NONE : mobilityType;
    }

    if (qName.equals(RawDataElementName_3_0_old.FRAME_ID.getElementName())) {
      frameId = Integer.parseInt(getTextOfElement());
    }

    if (qName.equals(RawDataElementName_3_0_old.MOBILITY_SCANNUM.getElementName())) {
      mobilityScans[mobilityScanCount++] = Integer.parseInt(getTextOfElement());
    }

    if (qName.equals(RawDataElementName_3_0_old.LOWER_MOBILITY_RANGE.getElementName())) {
      lowerMobilityRange = Double.parseDouble(getTextOfElement());
    }

    if (qName.equals(RawDataElementName_3_0_old.UPPER_MOBILITY_RANGE.getElementName())) {

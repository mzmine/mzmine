...
import io.github.mzmine.project.impl.IMSImagingRawDataFileImpl;
...
public class TDFImportTask extends AbstractTask {
   ...
   */
  private void appendScansFromTimsSegment(@NotNull final TDFUtils tdfUtils, final long handle,

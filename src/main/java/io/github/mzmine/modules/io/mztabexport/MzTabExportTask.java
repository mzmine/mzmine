...
class MzTabExportTask extends AbstractTask {
    ...
    MzTabExportTask(MZmineProject project, ParameterSet parameters) {
        ...
        this.fileName = parameters.getParameter(MzTabExportParameters.filename)
                .getValue();
        this.exportall = parameters
                .getParameter(MzTabExportParameters.exportall).getValue();
    }
    ...
    public void run() {
        ...
        for (PeakList peakList : peakLists) {
            ...
            try {
                ...
                mtd.addSoftwareParam(1, new CVParam("MS", "MS:1002342",
                        "MZmine", MZmineCore.getMZmineVersion()));
                mtd.setSmallMoleculeQuantificationUnit(
                        new CVParam("PRIDE", "PRIDE:0000330",
                                "Arbitrary quantification unit", null));
                ...
                for (RawDataFile file : rawDataFiles) {
                    ...
                    /**
                     * TO DO: Add path to original imported raw file to MZmine
                     * and write it out here instead
                     */
                    // MS run location
                    ...
                    for (UserParameter<?, ?> p : project.getParameters()) {
                        ...
                        for (StudyVariable studyVariable : mtd
                            ...
                            if (studyVariable.getDescription()
                                    .equals(String.valueOf(p) + ": "
                                            + String.valueOf(
                                                    project.getParameterValue(p,
                                                            file)))) {
                ...
                for (PeakListRow peakListRow : peakList.getRows()) {
                    ...
                    if (exportall || peakIdentity != null) {
                        ...
                        if (peakIdentity != null) {
                            ...
                            String identifier = escapeString(
                                    peakIdentity.getPropertyValue("ID"));
                            ...
                            String description = escapeString(
                                    peakIdentity.getPropertyValue("Name"));
                        ...
                        String rowRT = String
                                .valueOf(peakListRow.getAverageRT());
                        ...
                        for (RawDataFile dataFile : rawDataFiles) {
                            ...
                            if (peak != null) {
                                ...
                                String peakRT = String
                                        .valueOf(String.valueOf(peak.getRT()));
                                String peakHeight = String
                                        .valueOf(peak.getHeight());
                                Double peakArea = peak.getArea();

                                sm.setOptionColumnValue(
                                        new Assay(dataFileCount), "peak_mz",
                                        peakMZ);
                                sm.setOptionColumnValue(
                                        new Assay(dataFileCount), "peak_rt",
                                        peakRT);
                                sm.setOptionColumnValue(
                                        new Assay(dataFileCount), "peak_height",
                                        peakHeight);
                ...
                e.printStackTrace();
                setStatus(TaskStatus.ERROR);
                setErrorMessage("Could not export feature list to file "

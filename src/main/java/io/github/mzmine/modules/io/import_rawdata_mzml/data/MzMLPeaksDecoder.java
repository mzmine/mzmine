...
import io.github.mzmine.modules.io.import_rawdata_mzml.util.ByteBufferInputStream;
import io.github.mzmine.modules.io.import_rawdata_mzml.util.MSNumpress;
...
public class MzMLPeaksDecoder {
  ...
  public static float[] decodeToFloat(InputStream inputStream, MzMLBinaryDataInfo binaryDataInfo,
      float[] data) throws DataFormatException, IOException, MZmineException {
      ...
      switch (binaryDataInfo.getCompressionType()) {
        ...
        case NUMPRESS_LINPRED_ZLIB:
          ...
          if (numDecodedDoubles < 0) {
            throw new MZmineException("MSNumpress linear decoder failed");
          }
          return data;
        ...
        case NUMPRESS_POSINT_ZLIB:
          ...
          if (numDecodedDoubles < 0) {
            throw new MZmineException("MSNumpress positive integer decoder failed");
          }
          return data;
        ...
        case NUMPRESS_SHLOGF_ZLIB:
          ...
          if (numDecodedDoubles < 0) {
            throw new MZmineException("MSNumpress short logged float decoder failed");
          }
          return data;
        default:
          break;
  ...
  public static double[] decodeToDouble(InputStream inputStream, MzMLBinaryDataInfo binaryDataInfo,
      double[] data) throws DataFormatException, IOException, MZmineException {

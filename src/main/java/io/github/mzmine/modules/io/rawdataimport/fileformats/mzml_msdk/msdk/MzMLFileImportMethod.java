...
package io.github.mzmine.modules.io.rawdataimport.fileformats.mzml_msdk.msdk;
...
import io.github.mzmine.modules.io.rawdataimport.fileformats.mzml_msdk.msdk.data.MzMLParser;
...
import io.github.mzmine.modules.io.rawdataimport.fileformats.mzml_msdk.msdk.util.FileMemoryMapper;
import java.io.File;
...
public class MzMLFileImportMethod implements MSDKMethod<RawDataFile> {
   ...
   * </p>
   *
   * @return a {@link File File} instance of the MzML source if being read from a file <br>
   *         null if the MzML source is an {@link InputStream InputStream}
   */

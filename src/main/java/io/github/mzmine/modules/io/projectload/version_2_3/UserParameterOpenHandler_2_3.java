...
public class UserParameterOpenHandler_2_3 extends DefaultHandler
    ...
    public void startElement(String namespaceURI, String lName, String qName,
        ...
        // <PARAMETERS>
        if (qName.equals(
                UserParameterElementName_2_3.PARAMETERS.getElementName())) {
            String count = attrs.getValue(
                    UserParameterElementName_2_3.COUNT.getElementName());
            totalParams = Integer.parseInt(count);
        }

        // <PARAMETER>
        if (qName.equals(
                UserParameterElementName_2_3.PARAMETER.getElementName())) {

            String name = attrs.getValue(
                    UserParameterElementName_2_3.NAME.getElementName());
            String type = attrs.getValue(
                    UserParameterElementName_2_3.TYPE.getElementName());
        ...
        if (qName.equals(UserParameterElementName_2_3.VALUE.getElementName())) {
            currentDataFileID = attrs.getValue(
                    UserParameterElementName_2_3.DATA_FILE.getElementName());
        }
    ...
    public void endElement(String namespaceURI, String sName, String qName)
        ...
        // <OPTION>
        if (qName
                .equals(UserParameterElementName_2_3.OPTION.getElementName())) {

...
public class RawDataFileOpenHandler_2_0 extends DefaultHandler
    ...
    public void startElement(String namespaceURI, String lName, String qName,
        ...
        if (qName.equals(RawDataElementName_2_0.QUANTITY_FRAGMENT_SCAN
            ...
            numberOfFragments = Integer.parseInt(attrs.getValue(
                    RawDataElementName_2_0.QUANTITY.getElementName()));
    ...
    public void endElement(String namespaceURI, String sName, String qName)
        ...
        if (qName.equals(
                RawDataElementName_2_0.QUANTITY_SCAN.getElementName())) {
        ...
        if (qName
                .equals(RawDataElementName_2_0.PRECURSOR_MZ.getElementName())) {
            precursorMZ = Double.parseDouble(getTextOfElement());
        }

        if (qName.equals(
                RawDataElementName_2_0.PRECURSOR_CHARGE.getElementName())) {
            precursorCharge = Integer.parseInt(getTextOfElement());
        }

        if (qName.equals(
                RawDataElementName_2_0.RETENTION_TIME.getElementName())) {
        ...
        if (qName.equals(
                RawDataElementName_2_0.QUANTITY_DATAPOINTS.getElementName())) {
            dataPointsNumber = Integer.parseInt(getTextOfElement());
        }

        if (qName.equals(
                RawDataElementName_2_0.FRAGMENT_SCAN.getElementName())) {

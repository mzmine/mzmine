...
public class PeakListOpenHandler_2_5 extends DefaultHandler
    ...
    public void startElement(String namespaceURI, String lName, String qName,
        ...
        if (qName.equals(PeakListElementName_2_5.PEAK.getElementName())) {
            ...
            if (chargeString != null)
                ...
                currentPeakCharge = 0;
            try {
                parentChromatogramRowID = Integer.parseInt(attrs.getValue(
                        PeakListElementName_2_5.PARENT_CHROMATOGRAM_ROW_ID
                                .getElementName()));
    ...
    public void endElement(String namespaceURI, String sName, String qName)
        ...
        if (qName.equals(
                PeakListElementName_2_5.PEAK_INFORMATION.getElementName())) {
            PeakInformation information = new SimplePeakInformation(

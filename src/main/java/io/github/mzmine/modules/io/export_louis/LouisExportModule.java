 ...
 */
public class LouisExportModule implements MZmineProcessingModule {
  // #################################################################
  // IMPORTANT
  ...
  private static final String MODULE_NAME = "Louis' export";
  private static final String MODULE_DESCRIPTION = "An export function";
  ...
  public ExitCode runModule(@Nonnull MZmineProject project, @Nonnull ParameterSet parameters,
    ...
    FeatureList featureLists[] =
        parameters.getParameter(LouisExportParameters.featureLists).getValue().getMatchingFeatureLists();
    final MemoryMapStorage storage = MemoryMapStorage.forFeatureList();

    // create and start one task for each feature list
    for (final FeatureList featureList : featureLists) {
      Task newTask = new LouisExportTask(project, featureList, parameters, storage);
      tasks.add(newTask);
    }
  ...
  public @Nonnull Class<? extends ParameterSet> getParameterSetClass() {
    return LouisExportParameters.class;
  }

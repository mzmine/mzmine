...
public class HierarClusterer implements ClusteringAlgorithm {
    ...
    public ClusteringResult performClustering(Instances dataset,
        ...
        LinkType link = parameters
                .getParameter(HierarClustererParameters.linkType).getValue();
        DistanceType distanceType = parameters
                .getParameter(HierarClustererParameters.distanceType)
                .getValue();
        options[0] = "-L";
        options[1] = link.name();
        options[2] = "-A";

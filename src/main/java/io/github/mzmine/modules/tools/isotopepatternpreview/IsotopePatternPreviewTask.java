...
public class IsotopePatternPreviewTask extends AbstractTask {
    ...
    public void initialise(String formula, double minIntensity,
    ...
    public IsotopePatternPreviewTask(String formula, double minIntensity,
            double mergeWidth, int charge, PolarityType polarity,
            IsotopePatternPreviewDialog dialog) {
        message = "Wating for parameters";
        parametersChanged = false;
    ...
    public void run() {
        ...
        pattern = (ExtendedIsotopePattern) IsotopePatternCalculator
                .calculateIsotopePattern(formula, minIntensity, mergeWidth,
                        charge, polarity, true);
        if (pattern == null) {

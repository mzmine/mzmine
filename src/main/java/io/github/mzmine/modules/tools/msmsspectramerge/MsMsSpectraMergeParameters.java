...
public class MsMsSpectraMergeParameters extends SimpleParameterSet {
    ...
    public MsMsSpectraMergeParameters() {
        super(new Parameter[] { MERGE_MODE, MZ_MERGE_MODE, INTENSITY_MERGE_MODE,
                MASS_ACCURACY, COSINE_PARAMETER, PEAK_COUNT_PARAMETER,
                ISOLATION_WINDOW_OFFSET, ISOLATION_WINDOW_WIDTH });
    }
    ...
    public static final PercentParameter PEAK_COUNT_PARAMETER = new PercentParameter(
    ...
    public static final DoubleParameter ISOLATION_WINDOW_WIDTH = new DoubleParameter(
            ...
            "width (left and right from offset) of the isolation window",

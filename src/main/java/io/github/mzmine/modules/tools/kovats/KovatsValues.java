...
public class KovatsValues {
    public enum KovatsIndex {
        ...
        private String[] names = new String[] { "Methane", "Ethane", "Propane",
                ...
                "Nonadecane", "Icosane", "Henicosane", "Docosane", "Tricosane",
                "Tetracosane", "Pentacosane", "Hexacosane", "Heptacosane",
                "Octacosane", "Nonacosane", "Triacontane", "Hentriacontane",
                "Dotriacontane", "Tritriacontane", "Tetratriacontane",
                "Pentatriacontane", "Hexatriacontane", "Heptatriacontane",
        ...
        public static KovatsIndex[] getRange(int cFirst, int cLastInclusive) {
            ...
            cLastInclusive = Math.min(cLastInclusive,
                    KovatsIndex.values().length);
            if (cLastInclusive < cFirst)
                return new KovatsIndex[] { getByCarbon(cFirst) };
            else {
                return IntStream.rangeClosed(cFirst, cLastInclusive)
                        .mapToObj(KovatsIndex::getByCarbon)

...
public class CameraSearchParameters extends SimpleParameterSet {
    ...
    // Ionization Polarity
    public static final ComboParameter POLARITY = new ComboParameter(
            "Ionization Polarity", "Ionization Polarity",
            new Object[] { "positive", "negative" }, "positive");

    public static final BooleanParameter DONT_SPLIT_ISOTOPES = new BooleanParameter(
    ...
    public static final ComboParameter<String> ORDER = new ComboParameter<>(
            "Order", "Order of Isotope search and Shape correlation steps",
    ...
    public static final ComboParameter<String> GROUP_BY = new ComboParameter<>(
            "Group peaks by",
            "Order of Isotope search and Shape correlation steps",
            new String[] { GROUP_BY_ISOTOPE, GROUP_BY_PCGROUP },
            GROUP_BY_ISOTOPE);

    public static final BooleanParameter INCLUDE_SINGLETONS = new BooleanParameter(
            "Include singletons",
            "If checked, features with no found isotope pattern will be included",
            false);
    ...
    public CameraSearchParameters() {
        ...
        super(new Parameter[] { PEAK_LISTS, FWHM_SIGMA, FWHM_PERCENTAGE,
                ...
                INCLUDE_SINGLETONS, SUFFIX, RENGINE_TYPE });
    }
}

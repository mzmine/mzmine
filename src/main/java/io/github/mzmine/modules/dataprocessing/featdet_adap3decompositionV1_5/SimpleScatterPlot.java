...
public class SimpleScatterPlot extends EChartPanel {
    ...
    public SimpleScatterPlot(double[] xValues, double[] yValues,
            double[] colors, String xLabel, String yLabel) {
        super(null, true);
        ...
        chart = new JFreeChart("", new Font("SansSerif", Font.BOLD, 12), plot,
                false);
    ...
    public void updateData(double[] xValues, double[] yValues,
            double[] colors) {

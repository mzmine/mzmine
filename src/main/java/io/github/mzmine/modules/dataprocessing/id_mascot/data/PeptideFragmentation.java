...
public class PeptideFragmentation {
    ...
    public PeptideFragmentation(Peptide peptide,
        ...
        // b-ions
        Vector<FragmentIon> bSeries = PeptideUtils.calculateBions(peptideMasses,
                hydrogenMass);
        ...
        bSeries.addAll(
                PeptideUtils.calculateIonsLossH2O(singleBIons, hydrogenMass,
                        oxygenMass, index, false, FragmentIonType.B_H2O_ION));
        ...
        bSeries.addAll(
                PeptideUtils.calculateIonsLossNH3(singleBIons, hydrogenMass,
                        nitrogenMass, index, false, FragmentIonType.B_NH3_ION));
        ...
        // Y-ions
        Vector<FragmentIon> ySeries = PeptideUtils.calculateYions(peptideMasses,
                hydrogenMass, oxygenMass);
        ...
        ySeries.addAll(
                PeptideUtils.calculateIonsLossH2O(singleYIons, hydrogenMass,
                        oxygenMass, index, false, FragmentIonType.Y_H2O_ION));
        ...
        ySeries.addAll(
                PeptideUtils.calculateIonsLossNH3(singleYIons, hydrogenMass,
                        nitrogenMass, index, false, FragmentIonType.Y_NH3_ION));
        ...
        for (int i = 0; i < ionSeriesRules.length; i++) {
            ...
            case ZHH_SERIES:
                ...
                Vector<FragmentIon> zhhDoubleSeries = PeptideUtils
                        .calculateDoubleChargedIons(singleZHHIons, hydrogenMass,

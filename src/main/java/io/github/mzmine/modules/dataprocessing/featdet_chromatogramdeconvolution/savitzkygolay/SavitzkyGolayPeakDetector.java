...
public class SavitzkyGolayPeakDetector implements PeakResolver {
    ...
    public ResolvedPeak[] resolvePeaks(final Feature chromatogram,
        ...
        if (avgIntensity <= maxIntensity / 2.0) {
            ...
            final double[] secondDerivative = SGDerivative
                    .calculateDerivative(intensities, false, SG_FILTER_LEVEL);
            ...
            for (final Feature p : resolvedOriginalPeaks) {
                ...
                if (peakDuration.contains(
                        RangeUtils.rangeLength(p.getRawDataPointsRTRange()))
    ...
    private static Feature[] peaksSearch(final Feature chromatogram,
            ...
            final double noiseThreshold, CenterFunction mzCenterFunction,
            final double msmsRange, final double rTRangeMSMS) {
        ...
        for (int i = 1; i < totalNumberPoints; i++) {
            ...
            while (currentPeakStart < scanNumbers.length - 1) {
                ...
                if (chromatogram
                        .getDataPoint(scanNumbers[currentPeakStart]) == null) {
            ...
            if (currentPeakEnd - currentPeakStart > 0 && !activeFirstPeak) {
                ...
                resolvedPeaks.add(new ResolvedPeak(chromatogram,
                        currentPeakStart, currentPeakEnd, mzCenterFunction,

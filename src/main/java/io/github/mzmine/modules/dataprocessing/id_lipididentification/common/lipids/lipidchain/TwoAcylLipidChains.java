...
public class TwoAcylLipidChains implements ILipidChain {

  private static final String XML_ELEMENT = "twoacylchains";
  ...
  private static final LipidChainType LIPID_CHAIN_TYPE = LipidChainType.TWO_ACYL_CHAINS_COMBINED;
  private final int numberOfOxygens;

  public TwoAcylLipidChains(String chainAnnotation, IMolecularFormula molecularFormula,
  ...
  public static ILipidChain loadFromXML(XMLStreamReader reader) throws XMLStreamException {
    if (!(reader.isStartElement() && reader.getLocalName().equals(XML_ELEMENT))) {
      throw new IllegalStateException(
          "Cannot load combined acyl chains from the current element. Wrong name.");
    }

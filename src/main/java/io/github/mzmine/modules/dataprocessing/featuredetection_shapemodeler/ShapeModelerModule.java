...
public class ShapeModelerModule implements MZmineProcessingModule {
  ...
  private static final String MODULE_DESCRIPTION =
      "This module models the shape of the peak according to the detected data points.";
  ...
  public ExitCode runModule(@Nonnull MZmineProject project, @Nonnull ParameterSet parameters,
    ...
    PeakList peakLists[] =
        parameters.getParameter(ShapeModelerParameters.peakLists).getValue().getMatchingPeakLists();

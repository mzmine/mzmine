...
package io.github.mzmine.modules.dataprocessing.featuredetection_massdetection.wavelet;

import java.awt.Window;

import io.github.mzmine.main.MZmineCore;
import io.github.mzmine.modules.dataprocessing.featuredetection_massdetection.MassDetectorSetupDialog;
...
public class WaveletMassDetectorParameters extends SimpleParameterSet {
  ...
  public ExitCode showSetupDialog(Window parent, boolean valueCheckRequired) {
    MassDetectorSetupDialog dialog =
        new MassDetectorSetupDialog(parent, valueCheckRequired, WaveletMassDetector.class, this);

...
class LinearNormalizerTask extends AbstractTask {
    ...
    public LinearNormalizerTask(MZmineProject project, PeakList peakList,
        ...
        normalizationType = parameters
                .getParameter(LinearNormalizerParameters.normalizationType)
                .getValue();
        peakMeasurementType = parameters
                .getParameter(LinearNormalizerParameters.peakMeasurementType)
                .getValue();
        removeOriginal = parameters
                .getParameter(LinearNormalizerParameters.autoRemove).getValue();
            ...
            for (PeakListRow originalpeakListRow : originalPeakList.getRows()) {
                ...
                if (originalPeak != null) {
                    ...
                    if (normalizedRow == null) {
                        ...
                        PeakUtils.copyPeakListRowProperties(originalpeakListRow,
                                normalizedRow);

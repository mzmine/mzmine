...
public class EMGPeakModel implements Feature {
    ...
    private void initializEMGParameters(double[] intensities,
            double[] retentionTimes, double retentionTime,
            double maxIntensity) {
        ...
        double[] secondDerivative = SGDerivative
                .calculateDerivative(intensitiesWithZeros, false, 12);

...
public class ADAP3DecompositionV1_5Parameters extends SimpleParameterSet {
    ...
    public static final IntegerParameter MIN_CLUSTER_SIZE = new IntegerParameter(
            "Min cluster size", "Minimum size of a cluster", 2);
    ...
    public static final BooleanParameter USE_ISSHARED = new BooleanParameter(
            "Find shared peaks",
            "If selected, peaks are marked as Shared if they are composed of two or more peaks",
            false);

    public static final DoubleParameter MIN_MODEL_SHARPNESS = new DoubleParameter(
            "Min sharpness", "Minimum sharpness that the model peak can have",
    ...
    public static final ListDoubleRangeParameter MZ_VALUES = new ListDoubleRangeParameter(
            "Exclude m/z-values",
            "M/z-values to exclude while selecting model peak", false, null);
    ...
    public ADAP3DecompositionV1_5Parameters() {
        super(new Parameter[] { PEAK_LISTS, MIN_CLUSTER_DISTANCE,
                MIN_CLUSTER_SIZE, MIN_CLUSTER_INTENSITY, USE_ISSHARED,

 ...
 */
public class MassCalibrationSetupDialog2 extends ParameterSetupDialog {

  private ParameterSet parameters;

  public MassCalibrationSetupDialog2(boolean valueCheckRequired, ParameterSet parameters) {

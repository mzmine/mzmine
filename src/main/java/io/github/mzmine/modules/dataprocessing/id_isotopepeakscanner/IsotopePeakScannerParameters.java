...
public class IsotopePeakScannerParameters extends SimpleParameterSet {
    ...
    public static final StringParameter element = new StringParameter(
            "Chemical formula",
    ...
    public static final DoubleParameter minRating = new DoubleParameter(
            "Minimun rating",
            "Minimum rating to be considered as an isotope peak. min = 0.0, max = 1.0",
            new DecimalFormat("0.####"), 0.90, 0.0, 1.0);

    public static final String[] ratingTypeChoices = { "Highest intensity",
            "Temporary average" };
    ...
    public static final BooleanParameter showPreview = new BooleanParameter(
    ...
    public IsotopePeakScannerParameters() {
        super(new Parameter[] { PEAK_LISTS, mzTolerance, checkRT, rtTolerance,
                element, autoCarbonOpt, charge, minPatternIntensity, mergeWidth,
                showPreview, minHeight, checkIntensity, minRating,
    ...
    public ExitCode showSetupDialog(Window parent, boolean valueCheckRequired) {
        ...
        ParameterSetupDialog dialog = new IsotopePeakScannerSetupDialog(parent,

...
import static io.github.mzmine.modules.dataprocessing.id_sirius.table.ResultTableModel.PREVIEW_INDEX;
...
public class ResultTable extends JTable implements ComponentToolTipProvider {
  ...
  public void generateIconImage(SiriusCompound compound) {
    ...
    Image image =
        compound.generateImage(SiriusCompound.STRUCTURE_WIDTH, SiriusCompound.STRUCTURE_HEIGHT);
    if (image != null)

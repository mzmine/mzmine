...
public class PeakListBlankSubtractionParameters extends SimpleParameterSet {
    ...
    public static final PeakListsParameter alignedPeakList = new PeakListsParameter(
            "Aligned peak list", 1, 1);
    ...
    public PeakListBlankSubtractionParameters() {
        super(new Parameter[] { alignedPeakList, blankRawDataFiles, minBlanks,
                foldChange });
    };
}

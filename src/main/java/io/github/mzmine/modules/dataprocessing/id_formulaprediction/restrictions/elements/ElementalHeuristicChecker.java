...
public class ElementalHeuristicChecker {
    ...
    public static boolean checkFormula(IMolecularFormula formula,
        ...
        boolean checkHC = parameters
                .getParameter(ElementalHeuristicParameters.checkHC).getValue();
        boolean checkNOPS = parameters
                .getParameter(ElementalHeuristicParameters.checkNOPS)
                .getValue();
        boolean checkMultiple = parameters
                .getParameter(ElementalHeuristicParameters.checkMultiple)
                .getValue();

...
public enum LipidClasses {
    ...
    ALKYLACYLGLYCEROLS("Alkylacylglycerols", "DG",
            LipidCoreClasses.GLYCEROLIPIDS, LipidMainClasses.DIRADYLGLYCEROLS,
            "C4H6O4", 1, 1, new String[] { "" }, new String[] { "" }), //
    ...
    ALKYLDIACYLGLYCEROLS("Alkyldiacylglycerols", "TG",
            LipidCoreClasses.GLYCEROLIPIDS, LipidMainClasses.TRIRADYLGLYCEROLS,
            "C5H5O5", 2, 1, new String[] { "" }, new String[] { "" }), //
    DIALKYLMONOACYLGLYCEROLS("Dialkylmonoacylglycerols", "TG",
            LipidCoreClasses.GLYCEROLIPIDS, LipidMainClasses.TRIRADYLGLYCEROLS,
            "C4H5O4", 1, 2, new String[] { "" }, new String[] { "" }), //
    DIACYLGLYCEROLTRIMETHYLHOMOSERIN("Diacylglyceroltrimethylhomoserin", "DGTS",
            ...
            "C12H19O7N", 2, 0, new String[] { "fragment C7H14NO2 ",
                    "fragment C10H22NO5", "M-FA", "M-FA-H2O" },
            new String[] { "FA" }), //
    MONOACYLGLYCEROLTRIMETHYLHOMOSERIN("Monoacylglyceroltrimethylhomoserin",
            "LysoDGTS", LipidCoreClasses.GLYCEROLIPIDS,
            LipidMainClasses.OTHERGLYCEROLIPIDS, "C11H21O6N", 1, 0,
            new String[] { "fragment C7H14NO2 ", "M-FA", "M-FA-H2O" },
            new String[] { "FA" }), //
    SULFOQUINOVOSYLMONOACYLGLYCEROLS("Sulfoquinovosylmonoacylglycerols", "SQMG",
            LipidCoreClasses.GLYCEROLIPIDS,
            LipidMainClasses.GLYCOSYLMONOACYLGLYCEROLS, "C10H17O11S", 1, 0,
            new String[] { "" }, new String[] { "" }), //
    MONOGALACTOSYLDIACYLGLYCEROL("Monogalactosyldiacylglycerol", "MGDG",
            LipidCoreClasses.GLYCEROLIPIDS,
            LipidMainClasses.GLYCOSYLDIACYLGLYCEROLS, "C11H16O10", 2, 0,
            new String[] { "M-FA", "M-FA-H20", "M-FA-C6H11O6" },
            new String[] { "FA" }), //
    DIGALACTOSYLDIACYLGLYCEROL("Digalactosyldiacylglycerol", "DGDG",
            LipidCoreClasses.GLYCEROLIPIDS,
            LipidMainClasses.GLYCOSYLDIACYLGLYCEROLS, "C17H26O15", 2, 0,
            new String[] { "M-FA" }, new String[] { "FA" }), //
    SULFOQUINOVOSYLDIACYLGLYCEROLS("Sulfoquinovosyldiacylglycerols", "SQDG",
            LipidCoreClasses.GLYCEROLIPIDS,
            LipidMainClasses.GLYCOSYLDIACYLGLYCEROLS, "C11H16O12S", 2, 0,
    ...
    DIACYLGLYCEROPHOSPHOCHOLINES("Diacylglycerophosphocholines", "PC",
            ...
            LipidMainClasses.PHOSPHATIDYLCHOLINE, "C10H18O8PN", 2, 0,
            new String[] { "M-FA", "M-FA-H2O", "fragment C5H15NO4P" },
            new String[] { "FA" }), //
    DIALKYLGLYCEROPHOSPHOCHOLINES("Dialkylglycerophosphocholines", "PC",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.PHOSPHATIDYLCHOLINE, "C8H18O6PN", 0, 2,
            new String[] { "" }, new String[] { "" }), //
    ALKYLACYLGLYCEROPHOSPHOCHOLINES("Alkylacylglycerophosphocholines", "PC",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.PHOSPHATIDYLCHOLINE, "C9H18O7PN", 1, 1,
            new String[] { "" }, new String[] { "" }), //
    MONOACYLGLYCEROPHOSPHOCHOLINES("Monoacylglycerophosphocholines", "PC",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.PHOSPHATIDYLCHOLINE, "C9H19O7PN", 1, 0,
            new String[] { "M-FA", "M-FA-H2O", "fragment C5H15NO4P" },
            new String[] { "" }), //
    MONOALKYLGLYCEROPHOSPHOCHOLINES("Monoalkylglycerophosphocholines", "PC",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.PHOSPHATIDYLCHOLINE, "C8H19O6PN", 0, 1,
            new String[] { "" }, new String[] { "" }), //
    DIACYLGLYCEROPHOSPHOETHANOLAMINES("Diacylglycerophosphoethanolamines", "PE",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOETHANOLAMINES, "C7H12O8PN", 2, 0,
            new String[] { "M-FA", "M-FA-H2O", "M-C2H8NO4P" },
            new String[] { "FA", "M-FA", "M-FA-H2O", "fragment C5H11NO5P" }), //
    DIALKYLGLYCEROPHOSPHOETHANOLAMINES("Dialkylglycerophosphoethanolamines",
            "PE", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOETHANOLAMINES, "C5H12O6PN", 0, 2,
            new String[] { "" }, new String[] { "" }), //
    ALKYLACYLGLYCEROPHOSPHOETHANOLAMINES("Alkylacylglycerophosphoethanolamines",
            "PE", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOETHANOLAMINES, "C6H12O7PN", 1, 1,
            new String[] { "" }, new String[] { "" }), //
    MONOACYLGLYCEROPHOSPHOETHANOLAMINES("Monoacylglycerophosphoethanolamines",
            "PE", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOETHANOLAMINES, "C6H13O7PN", 1, 0,
            new String[] { "M-C2H8NO4P" },
            new String[] { "FA", "M-FA", "M-FA-H2O", "M-C2H7NO" }), //
    MONOALKYLGLYCEROPHOSPHOETHANOLAMINES("Monoalkylglycerophosphoethanolamines",
            "PE", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOETHANOLAMINES, "C5H13O6PN", 0, 1,
            new String[] { "" }, new String[] { "" }), //
    DIACYLGLYCEROPHOSPHOSERINES("Diacylglycerophosphoserines", "PS",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOSERINES, "C8H12O10PN", 2, 0,
            new String[] { "" }, new String[] { "FA", "fragment M-C3H5NO2",
                    "fragment M-C3H5NO2-FA" }), //
    DIALKYLGLYCEROPHOSPHOSERINES("Dialkylglycerophosphoserines", "PS",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOSERINES, "C6H12O8PN", 0, 2,
            new String[] { "" }, new String[] { "" }), //
    ALKYLACYLGLYCEROPHOSPHOSERINES("Alkylacylglycerophosphoserines", "PS",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOSERINES, "C7H12O9PN", 1, 1,
            new String[] { "" }, new String[] { "" }), //
    MONOACYLGLYCEROPHOSPHOSERINES("Monoacylglycerophosphoserines", "PS",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOSERINES, "C7H13O9PN", 1, 0,
            new String[] { "" }, new String[] { "fragment M-C3H5NO2" }), //
    MONOALKYLGLYCEROPHOSPHOSERINES("Monoalkylglycerophosphoserines", "PS",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOSERINES, "C6H13O8PN", 0, 1,
            new String[] { "" }, new String[] { "" }), //
    DIACYLGLYCEROPHOSPHOGLYCEROLS("Diacylglycerophosphoglycerols", "PG",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOGLYCEROLS, "C8H13O10P", 2, 0,
            new String[] { "" }, new String[] { "FA", "M-FA", "M-FA-H2O" }), //
    DIALKYLGLYCEROPHOSPHOGLYCEROLS("Dialkylglycerophosphoglycerols", "PG",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOGLYCEROLS, "C6H13O8P", 0, 2,
            new String[] { "" }, new String[] { "" }), //
    ALKYLACYLGLYCEROPHOSPHOGLYCEROLS("Alkylacylglycerophosphoglycerols", "PG",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOGLYCEROLS, "C7H13O9P", 1, 1,
            new String[] { "" }, new String[] { "" }), //
    MONOACYLGLYCEROPHOSPHOGLYCEROLS("Monoacylglycerophosphoglycerols", "PG",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOGLYCEROLS, "C7H14O9P", 1, 0,
            new String[] { "" }, new String[] { "" }), //
    MONOALKYLGLYCEROPHOSPHOGLYCEROLS("Monoalkylglycerophosphoglycerols", "PG",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOGLYCEROLS, "C6H14O8P", 0, 1,
            new String[] { "" }, new String[] { "" }), //
    DIACYLGLYCEROPHOSPHOGLYCEROPHOSPHATES(
            "Diacylglycerophosphoglycerophosphates", "PGP",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOGLYCEROPHOSPHATES, "C8H14O13P2", 2,
            0, new String[] { "" }, new String[] { "" }), //
    DIALKYLGLYCEROPHOSPHOGLYCEROPHOSPHATES(
            "Dialkylglycerophosphoglycerophosphates", "PGP",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOGLYCEROPHOSPHATES, "C6H14O11P2", 0,
            2, new String[] { "" }, new String[] { "" }), //
    ALKYLACYLGLYCEROPHOSPHOGLYCEROPHOSPHATES(
            "Alkylacylglycerophosphoglycerophosphates", "PGP",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOGLYCEROPHOSPHATES, "C7H14O12P2", 1,
            1, new String[] { "" }, new String[] { "" }), //
    MONOACYLGLYCEROPHOSPHOGLYCEROPHOSPHATES(
            "Monoacylglycerophosphoglycerophosphates", "PGP",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOGLYCEROPHOSPHATES, "C7H15O12P2", 1,
            0, new String[] { "" }, new String[] { "" }), //
    MONOALKYLGLYCEROPHOSPHOGLYCEROPHOSPHATES(
            "Monoalkylglycerophosphoglycerophosphates", "PGP",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOGLYCEROPHOSPHATES, "C6H15O11P2", 0,
            1, new String[] { "" }, new String[] { "" }), //
    DIACYLGLYCEROPHOSPHOINOSITOLS("Diacylglycerophosphoinositols", "PI",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOINOSITOLS, "C11H17O13P", 2, 0,
            new String[] { "" }, new String[] { "FA", "M-FA", "M-FA-C6H12O6" }), //
    DIALKYLGLYCEROPHOSPHOINOSITOLS("Dialkylglycerophosphoinositols", "PI",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOINOSITOLS, "C9H17O11P", 0, 2,
            new String[] { "" }, new String[] { "" }), //
    ALKYLACYLGLYCEROPHOSPHOINOSITOLS("Alkylacylglycerophosphoinositols", "PI",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOINOSITOLS, "C10H17O11P", 1, 1,
            new String[] { "" }, new String[] { "" }), //
    MONOACYLGLYCEROPHOSPHOINOSITOLS("Monoacylglycerophosphoinositols", "PI",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOINOSITOLS, "C10H18O11P", 1, 0,
            new String[] { "" }, new String[] { "" }), //
    MONOALKYLGLYCEROPHOSPHOINOSITOLS("Monoalkylglycerophosphoinositols", "PI",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOINOSITOLS, "C9H18O10P", 0, 1,
            new String[] { "" }, new String[] { "" }), //
    DIACYLGLYCEROPHOSPHOINOSITOLMONOMANNOSIDE(
            "Diacylglycerophosphoinositolmonomannoside", "AC2PIM1",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOINOSITOLGLYCANS, "C17H27O18P", 2, 0,
            new String[] { "" },
            new String[] { "FA", "M-FA", "M-C6H10O5", "M-FA-C12H20O10" }), //
    DIACYLGLYCEROPHOSPHOINOSITOLDIMANNOSIDE(
            "Diacylglycerophosphoinositoldimannoside", "AC2PIM2",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOINOSITOLGLYCANS, "C23H37O23P", 2, 0,
            new String[] { "" }, new String[] { "FA", "M-FA", "M-C6H10O5" }), //
    TRIACYLPHOSPHATIDYLINOSITOLDIMANNOSIDE(
            "Triacylglycerophosphoinositoldimannoside", "AC3PIM2",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOINOSITOLGLYCANS, "C24H36O24P", 3, 0,
            new String[] { "" }, new String[] { "FA", "M-FA", "M-FA+H2O",
                    "M-FA-FA", "M-FA-FA-C3H5O", "M-C6H10O5" }), //
    TETRAACYLPHOSPHATIDYLINOSITOLDIMANNOSIDE(
            "Tetraacylglycerophosphoinositoldimannoside", "AC3PIM2",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHOINOSITOLGLYCANS, "C25H35O25P", 4, 0,
            new String[] { "" },
    ...
    ALKYLACYLGLYCEROPHOSPHATES("Alkylacylglycerophosphates", "PA",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHATES, "C4H7O7P", 1, 1,
            new String[] { "" }, new String[] { "" }), //
    MONOACYLGLYCEROPHOSPHATES("Monoacylglycerophosphates", "PA",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHATES, "C4H8O7P", 1, 0,
            new String[] { "" }, new String[] { "FA" }), //
    MONOALKYLGLYCEROPHOSPHATES("Monoalkylglycerophosphates", "PA",
            LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
            LipidMainClasses.GLYCEROPHOSPHATES, "C3H8O6P", 0, 1,
            new String[] { "" }, new String[] { "" }), //
    ...
    NACYLSPHINGOSINES("N-acylsphingosines", "Cer",
            LipidCoreClasses.SPHINGOLIPIDS, LipidMainClasses.CERAMIDES, "CHO3N",
            1, 1, new String[] { "" }, new String[] { "" }), //
    NACYL4HYDROXYSPHINGANINES("N-acyl-4-hydroxysphinganines", "Cer",
            LipidCoreClasses.SPHINGOLIPIDS, LipidMainClasses.CERAMIDES, "CHO4N",
            1, 1, new String[] { "M-OH", "M-OH-H2O", "M-FA-OH", "M-FA-OH-H2O" },
            new String[] { "" }), //
    ACYLCERAMIDES("Acylceramides", "Cer", LipidCoreClasses.SPHINGOLIPIDS,
            LipidMainClasses.CERAMIDES, "C2O4N", 2, 1, new String[] { "" },
            new String[] { "" }), //
    CERAMIDE1PHOSPHATES("Ceramide 1-phosphates", "CerP",
            LipidCoreClasses.SPHINGOLIPIDS, LipidMainClasses.CERAMIDES,
            "CH2O6PN", 1, 1, new String[] { "" }, new String[] { "M-H2O",
                    "M-FA", "M-FA-H2O", "fragment H2PO4", "fragment PO3" }); //
    ...
    LipidClasses(String name, String abbr, LipidCoreClasses coreClass,
            LipidMainClasses mainClass, String backBoneFormula,
            int numberOfAcylChains, int numberOfAlkylChains,
            String[] msmsFragmentsPositiveIonization,
            String[] msmsFragmentsNegativeIonization) {
        this.name = name;
        this.abbr = abbr;
    ...
    public void setMsmsFragmentsPositiveIonization(
            String[] msmsFragmentsPositiveIonization) {
        this.msmsFragmentsPositiveIonization = msmsFragmentsPositiveIonization;
    }
    ...
    public void setMsmsFragmentsNegativeIonization(
            String[] msmsFragmentsNegativeIonization) {
        this.msmsFragmentsNegativeIonization = msmsFragmentsNegativeIonization;
    }

...
import io.github.mzmine.modules.dataprocessing.id_sirius.table.ResultTableModel;
...
/**
 * ResultWindow object for Sirius module Appears when SingleIdentificationTask
 * is called Shows results of Sirius module, default sort by FingerId score. 1)
 * Processing by SiriusIdentificationMethod 2) Processing by
 * FingerIdIdentificationMethod (using parallel threads)
 *
 * FingerId score is negative, the closer it to 0, the better it is. Sirius
 * score
 */
public class ResultWindow extends JFrame implements ActionListener {
    ...
    public ResultWindow(PeakListRow peakListRow, Task searchTask) {
        ...
        GUIUtils.addButton(pnlButtons, "Copy SMILES string", null, this,
                "COPY_SMILES");
        GUIUtils.addButton(pnlButtons, "Copy Formula string", null, this,
                "COPY_FORMULA");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (command.equals("COPY_FORMULA")) {
            ...
            String formula = listElementModel.getCompoundAt(realRow)
                    .getStringFormula();
        ...
        if (command.equals("DB_LIST")) {
            ...
            int realRow = compoundsTable.convertRowIndexToModel(row);
            final SiriusCompound compound = listElementModel
                    .getCompoundAt(realRow);
     ...
     * 
     * @param content
     *            - Formula or SMILES string
     * @param errorMessage
     *            - to print in a message if value of `content` is null
     */
     ...
     * 
     * @param annotations
     *            - SiriusIonAnnotation results processed by Sirius/FingerId
     *            methods
     */

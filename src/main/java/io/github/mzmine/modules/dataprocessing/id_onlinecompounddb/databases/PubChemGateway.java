...
public class PubChemGateway implements DBGateway {
    ...
    public static final String searchURL = "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?usehistory=y&db=pccompound&sort=cida&retmax=";
    public static final String compoundURL = "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esummary.fcgi?db=pccompound&rettype=xml";
    ...
    public String[] findCompounds(double mass, MZTolerance mzTolerance,
        ...
        final Range<Double> toleranceRange = mzTolerance
                .getToleranceRange(mass);
        ...
        try {
            ...
            NodeList webEnvNL = (NodeList) expr.evaluate(parsedResult,
            ...
            NodeList queryKeyNL = (NodeList) expr.evaluate(parsedResult,
                    XPathConstants.NODESET);
            ...
            NodeList cidElements = (NodeList) expr.evaluate(parsedResult,
                    XPathConstants.NODESET);
            ...
            logger.finest("Loading compounds from PubChem via URL "
                    + compoundUrl.toString());

            Document compoundSummaryDocument = builder
                    .parse(compoundUrl.toString());
            NodeList docSumElements = compoundSummaryDocument
                    .getDocumentElement().getElementsByTagName("DocSum");
    ...
    public DBCompound getCompound(String CID, ParameterSet parameters)
        ...
        try {
            ...
            /*
             * XPathExpression expr =
             * xpath.compile("Item[@Name='MeSHHeadingList']/Item"); NodeList
             * nameElementNL = (NodeList) expr.evaluate(docSumElement,
             * XPathConstants.NODESET); Element nameElement = (Element)
             * nameElementNL.item(0);
             */

            XPathExpression expr = xpath
                    .compile("Item[@Name='SynonymList']/Item");
            NodeList nameElementNL = (NodeList) expr.evaluate(docSumElement,
                    XPathConstants.NODESET);
            ...
            NodeList formulaElementNL = (NodeList) expr.evaluate(docSumElement,
                    XPathConstants.NODESET);
            ...
            DBCompound newCompound = new DBCompound(OnlineDatabases.PubChem,
                    CID, compoundName, compoundFormula, entryURL,

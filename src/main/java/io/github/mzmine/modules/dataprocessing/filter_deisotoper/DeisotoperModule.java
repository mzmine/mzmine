 ...
 * 
 */
public class DeisotoperModule implements MZmineProcessingModule {
  ...
  public ExitCode runModule(@Nonnull MZmineProject project, @Nonnull ParameterSet parameters,
    ...
    PeakList peakLists[] = parameters.getParameter(DeisotoperParameters.peakLists).getValue()
        .getMatchingPeakLists();

    for (final PeakList peakList : peakLists) {
      Task newTask = new DeisotoperTask(project, peakList, parameters);
      tasks.add(newTask);
    }
  ...
  public @Nonnull Class<? extends ParameterSet> getParameterSetClass() {
    return DeisotoperParameters.class;
  }

...
public final class SGCoefficients {
    ...
    public static final double[][] SGCoefficientsFirstDerivative = { { 0.0 },
            { 0.0, 0.500 }, { 0.0, 0.100, 0.200 }, { 0.0, 0.036, 0.071, 0.107 },
    ...
    public static final double[][] SGCoefficientsFirstDerivativeQuartic = {
            { 0.0 }, { 0.0, 0.667 }, { 0.0, 0.667, -0.083 },
            { 0.0, 0.230, 0.266, -0.087 }, { 0.0, 0.106, 0.162, 0.120, -0.072 },
    ...
    public static final double[][] SGCoefficientsSecondDerivative = { { 0.0 },
            { -1.0, 0.5 }, { -0.143, -0.071, 0.143 },
    ...
    public static final double[][] SGCoefficientsSecondDerivativeQuartic = {
            { 0.0 }, { -1.250, 0.567 }, { -1.250, 0.567, -0.042 },
            ...
            { -0.014, -0.012, -0.008, -0.001, 0.006, 0.012, 0.013, 0.007,
                    -0.011 },
            { -0.010, -0.009, -0.006, -0.002, 0.002, 0.007, 0.009, 0.009, 0.004,
                    -0.008 },
            { -0.007, -0.007, -0.005, -0.003, 0.000, 0.003, 0.006, 0.007, 0.006,
                    0.002, -0.006 },

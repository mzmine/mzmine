...
public class PeakComparisonRowFilterModule implements MZmineProcessingModule {
    ...
    private static final String MODULE_DESCRIPTION = "This method removes certain rows from a feature list based on peak comparisons.";
    ...
    public ExitCode runModule(@Nonnull MZmineProject project,
        ...
        final PeakList[] peakLists = parameters
                .getParameter(PeakComparisonRowFilterParameters.PEAK_LISTS)
                .getValue().getMatchingPeakLists();

        for (PeakList peakList : peakLists) {

            Task newTask = new PeakComparisonRowFilterTask(project, peakList,
                    parameters);
            tasks.add(newTask);

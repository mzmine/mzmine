...
public class ShoulderPeaksFilterTask extends AbstractTask {
     ...
     * @param parameters
     */
    public ShoulderPeaksFilterTask(RawDataFile dataFile,
        ...
        this.massListName = parameters
                .getParameter(ShoulderPeaksFilterParameters.massList)
                .getValue();

        this.suffix = parameters
                .getParameter(ShoulderPeaksFilterParameters.suffix).getValue();
        this.autoRemove = parameters
                .getParameter(ShoulderPeaksFilterParameters.autoRemove)
                .getValue();
    ...
    public void run() {
        ...
        for (int i = 0; i < totalScans; i++) {
            ...
            DataPoint newMzPeaks[] = ShoulderPeaksFilter
                    .filterMassValues(mzPeaks, parameters);

            SimpleMassList newMassList = new SimpleMassList(
                    massListName + " " + suffix, scan, newMzPeaks);

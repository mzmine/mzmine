...
public class ImsExpanderSubTask2 extends AbstractTask {

  private static final Logger logger = Logger.getLogger(ImsExpanderSubTask2.class.getName());

  protected final ParameterSet parameters;
  private final List<Frame> frames;
  private final ModularFeatureList flist;
  private List<ExpandingTrace2> expandingTraces;
  ...
  public ImsExpanderSubTask2(@Nullable final MemoryMapStorage storage,
      @NotNull final ParameterSet parameters, @NotNull final List<Frame> frames,
      @NotNull final ModularFeatureList flist, @NotNull final List<ExpandingTrace2> expandingTraces,
    ...
    this.useRawData = parameters.getParameter(ImsExpanderParameters2.useRawData).getValue();
    this.customNoiseLevel = parameters.getParameter(ImsExpanderParameters2.useRawData)

...
public class AcrossSamplesCorrelateGroupingParameters extends SimpleParameterSet {
  ...
  // GROUPING
  // sample sets
  public static final ComboParameter<Object> GROUPSPARAMETER =
      new ComboParameter<>("Sample group",
  ...
  public AcrossSamplesCorrelateGroupingParameters(RTTolerance rtTol, boolean useGroups,
      String gParam,
    ...
    this.getParameter(GROUPSPARAMETER).setValue(gParam);
  ...
  public ExitCode showSetupDialog(boolean valueCheckRequired) {
    ...
    getParameter(AcrossSamplesCorrelateGroupingParameters.GROUPSPARAMETER).setChoices(choices);
    if (choices.length > 1) {
      getParameter(AcrossSamplesCorrelateGroupingParameters.GROUPSPARAMETER).setValue(choices[1]);
    }

...
import io.github.mzmine.modules.dataprocessing.featuredetection_chromatogramdeconvolution.PeakResolverSetupDialog;
...
public class CentWaveDetectorParameters extends SimpleParameterSet {
  ...
  public ExitCode showSetupDialog(Window parent, boolean valueCheckRequired) {
    ...
    final PeakResolverSetupDialog dialog =
        new PeakResolverSetupDialog(parent, valueCheckRequired, this, CentWaveDetector.class);

...
package io.github.mzmine.modules.dataprocessing.featuredetection_msms;
...
public class MsMsPeakPickerModule implements MZmineProcessingModule {
  ...
  private static final String MODULE_DESCRIPTION =
      "This module looks through the whole raw data for MS2 scans and makes a list of chromatographic peaks using the precursor mass.";

...
public class RansacAlignerSetupDialog extends ParameterSetupDialog
    ...
    protected void addDialogComponents() {
        ...
        mainPanel.add(new JSeparator(), 0, getNumberOfParameters() + 1, 3, 1, 0,
    ...
    private Vector<AlignStructMol> getVectorAlignment(PeakList peakListX,
        ...
        for (PeakListRow row : peakListX.getRows()) {
            ...
            MZTolerance mzTolerance = super.parameterSet
                    .getParameter(RansacAlignerParameters.MZTolerance)
                    .getValue();
            RTTolerance rtTolerance = super.parameterSet

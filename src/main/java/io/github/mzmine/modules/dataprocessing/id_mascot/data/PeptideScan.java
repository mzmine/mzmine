...
import io.github.mzmine.util.PeptideSorter;
...
public class PeptideScan implements Scan {
    ...
    /**
     * @see io.github.mzmine.datamodel.Scan#getParentScanNumber()
     */
    ...
    public Peptide getHighScorePeptide() {
        ...
        Arrays.sort(sortedPeptides,
                new PeptideSorter(SortingDirection.Descending));

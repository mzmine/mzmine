...
class Gap {
    ...
    void offerNextScan(Scan scan) {
        ...
        if (basePeak != null) {
            ...
            currentDataPoint = new GapDataPoint(scan.getScanNumber(), mzCenter,
                    scanRT, 0);
        }
        ...
        if (bestPeakDataPoints != null) {
            ...
            if (height >= noiseLevel) {
                SimpleFeature newPeak = new SimpleFeature(rawDataFile, mz, rt,
                        ...
                        FeatureStatus.ESTIMATED, representativeScan,
                        fragmentScan, allMS2fragmentScanNumbers, finalRTRange,

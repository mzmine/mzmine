...
public class BaselineCorrectionParameters extends SimpleParameterSet {
    ...
    public static final BaselineCorrector baselineCorrectors[] = {
            new AsymmetryCorrector(), // (Package
                                      // R "ptw"
                                      // -
    ...
    public static final DoubleParameter MZ_BIN_WIDTH = new DoubleParameter(
            "m/z bin width",
            "The m/z bin size (>= 0.001) to use when the \""
    ...
    public static final IntegerParameter MS_LEVEL = new IntegerParameter(
            "MS level", "MS level of scans to apply this method to", 1, 1,
            null);
    ...
    public BaselineCorrectionParameters() {
        super(new Parameter[] { dataFiles, SUFFIX, CHROMOTAGRAM_TYPE, MS_LEVEL,
                USE_MZ_BINS, MZ_BIN_WIDTH, BASELINE_CORRECTORS, RENGINE_TYPE,
                REMOVE_ORIGINAL });
        thisParameters = null;
    }

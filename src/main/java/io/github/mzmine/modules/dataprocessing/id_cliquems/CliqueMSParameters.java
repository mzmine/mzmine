...
public class CliqueMSParameters extends SimpleParameterSet {
  ...
  public static OptionalModuleParameter FILTER = new OptionalModuleParameter("Filter similar features",
      "Marks all except one of the similar features. Two features are similar if their relative change in m/z, rt and intensity are less than the respective tolerances.",new SimilarFeatureParameters(),true);
  ...
  public CliqueMSParameters(){
    super(new Parameter[]{PEAK_LISTS, FILTER, TOL, ISOTOPES_MAX_CHARGE, ISOTOPES_MAXIMUM_GRADE, ISOTOPES_MZ_TOLERANCE, ISOTOPE_MASS_DIFF, ANNOTATE_TOP_MASS, ANNOTATE_TOP_MASS_FEATURE, POLARITY, SIZE_ANG, ANNOTATE_TOL, ANNOTATE_FILTER, ANNOTATE_EMPTY_SCORE, ANNOTATE_NORMALIZE});
  }

...
public class PeakResolverSetupDialog extends ParameterSetupDialog {
    ...
    public PeakResolverSetupDialog(Window parent, boolean valueCheckRequired,
        ...
        this(parent, valueCheckRequired, resolverParameters, resolverClass,
                null);
    }

    /**
     * Method to display setup dialog with a html-formatted footer message at
     * the bottom.
     *
     * @param message:
     *            html-formatted text
            ...
            if (previewRow != null) {
                ...
                try {
                    ...
                    if (peakResolver.getRequiresR()) {
                        ...
                        REngineType rEngineType = peakResolver
                                .getREngineType(parameters);

 ...
 *
 */
class DeisotoperTask extends AbstractTask {
  ...
  protected MolecularFormulaRange isotopesAllowed;

  /**
   * @param rawDataFile
   * @param parameters
   */
  DeisotoperTask(MZmineProject project, PeakList peakList, ParameterSet parameters) {
    ...
    suffix = parameters.getParameter(DeisotoperParameters.suffix).getValue();
    mzTolerance = parameters.getParameter(DeisotoperParameters.mzTolerance).getValue();
    rtTolerance = parameters.getParameter(DeisotoperParameters.rtTolerance).getValue();
    monotonicShape = parameters.getParameter(DeisotoperParameters.monotonicShape).getValue();
    maximumCharge = parameters.getParameter(DeisotoperParameters.maximumCharge).getValue();
    chooseMostIntense = (parameters.getParameter(DeisotoperParameters.representativeIsotope)
        .getValue() == DeisotoperParameters.ChooseTopIntensity);
    removeOriginal = parameters.getParameter(DeisotoperParameters.autoRemove).getValue();

    isotopesAllowed = parameters.getParameter(DeisotoperParameters.elementsParameter).getValue();

...
public class ExactMassDetector implements MassDetector {
    ...
    public DataPoint[] getMassValues(DataPoint dataPoints[],
        ...
        double noiseLevel = parameters
                .getParameter(ExactMassDetectorParameters.noiseLevel)
                .getValue();
     ...
     * @return
     */
    private void getLocalMaxima(DataPoint scanDataPoints[],
        ...
        for (int i = 0; i < scanDataPoints.length - 1; i++) {
            ...
            boolean nextIsBigger = scanDataPoints[i + 1]
                    .getIntensity() > scanDataPoints[i].getIntensity();
            ...
            if ((!ascending) && (nextIsBigger || nextIsZero)) {
                ...
                if (localMaximum.getIntensity() > noiseLevel) {
                    ...
                    candidatePeaks.add(
                            new ExactMzDataPoint(localMaximum, rawDataPoints));
                }

...
public class ShoulderPeaksFilter {
    ...
    public static DataPoint[] filterMassValues(DataPoint[] mzPeaks,
        ...
        double resolution = parameters
                .getParameter(ShoulderPeaksFilterParameters.resolution)
                .getValue();
        ...
        try {
            PeakModelType type = parameters
                    .getParameter(ShoulderPeaksFilterParameters.peakModel)
                    .getValue();
            if (type == null)

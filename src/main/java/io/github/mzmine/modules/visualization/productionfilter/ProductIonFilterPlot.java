...
class ProductIonFilterPlot extends ChartPanel {
    ...
    private static final Shape dataPointsShape = new Ellipse2D.Double(-1, -1, 2,
            2);
    ...
    ProductIonFilterPlot(ProductIonFilterVisualizerWindow visualizer,
            ProductIonFilterDataSet dataset, Object xAxisType) {

...
public class HistogramWindow extends JFrame {
    ...
    public HistogramWindow(ParameterSet parameters) {
        ...
        RawDataFile rawDataFiles[] = parameters
                .getParameter(HistogramParameters.dataFiles).getValue();

        HistogramDataType dataType = parameters
                .getParameter(HistogramParameters.dataRange).getType();
        int numOfBins = parameters.getParameter(HistogramParameters.numOfBins)
                .getValue();
        Range<Double> range = parameters
                .getParameter(HistogramParameters.dataRange).getValue();

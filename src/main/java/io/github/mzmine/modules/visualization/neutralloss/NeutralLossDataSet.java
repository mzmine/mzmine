...
class NeutralLossDataSet extends AbstractXYDataset
    ...
    NeutralLossDataSet(RawDataFile rawDataFile, Object xAxisType,
        ...
        dataSeries.put(PRECURSOR_LEVEL,
                new Vector<NeutralLossDataPoint>(totalScans));
        ...
        for (int scanNumber : scanNumbers) {
            ...
            for (int i = 0; i < scanDataPoints.length; i++) {
                ...
                fragmentsCycle: for (int j = 0; j < numOfFragments; j++) {
                    ...
                    if ((topPeaks[j] < 0) || (scanDataPoints[i]
                            .getIntensity()) > scanDataPoints[topPeaks[j]]
                                    .getIntensity()) {

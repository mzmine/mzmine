 ...
 */
public class ProductIonFilterSetHighlightDialog extends JDialog
    ...
    public ProductIonFilterSetHighlightDialog(ProductIonFilterPlot plot,
            String command) {
        ...
        fieldMinMZ.setPreferredSize(
                new Dimension(50, fieldMinMZ.getPreferredSize().height));
        constraints.gridx = 1;
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (src == btnOK) {
            ...
            try {
                ...
                ProductIonFilterDataSet dataSet = (ProductIonFilterDataSet) plot
                        .getXYPlot().getDataset();
                dataSet.updateOnRangeDataPoints(rangeType);
                plot.getXYPlot()
                        .datasetChanged(new DatasetChangeEvent(plot, dataSet));

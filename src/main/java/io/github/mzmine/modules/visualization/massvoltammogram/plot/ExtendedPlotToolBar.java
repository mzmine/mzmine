...
public class ExtendedPlotToolBar extends PlotToolBar {
  ...
  final public JToggleButton moveButton = buttonCenter;
  final public JToggleButton rotateButton = buttonRotate;
  final public JButton resetPlotButton = buttonReset;

...
/**
 * Production ion filter visualizer generated by Shawn Hoogstra :
 * shoogstr@uwo.ca Filter ms/ms scan based upon desired m/z and neutral loss m/z
 * values
 */
public class ProductIonFilterVisualizerModule implements MZmineRunnableModule {
    ...
    public ExitCode runModule(@Nonnull MZmineProject project,
        ...
        RawDataFile dataFiles[] = parameters
                .getParameter(ProductIonFilterParameters.dataFiles).getValue()
                .getMatchingRawDataFiles();

        ProductIonFilterVisualizerWindow newWindow = new ProductIonFilterVisualizerWindow(

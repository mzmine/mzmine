...
public class TICVisualizerWindow extends JFrame implements ActionListener {
        ...
        if (peaks != null) {
            ...
            for (Feature peak : peaks) {
                ...
                if (peakLabels != null && peakLabels.containsKey(peak)) {
                    ...
                    ticPlot.addLabelledPeakDataset(new PeakDataSet(peak, label),
                            label);
    ...
    void updateTitle() {
        ...
        Range<Double> mzRange2 = Range.range(mzRange.lowerEndpoint() - 1,
                BoundType.CLOSED, mzRange.upperEndpoint() + 1,
                BoundType.CLOSED);
        ...
        if (pos != null) {
            ...
            subTitle.append(
                    ", IC: " + intensityFormat.format(pos.getIntensityValue()));
        }
    ...
    public void setRTRange(Range<Double> rtRange) {
        ticPlot.getXYPlot().getDomainAxis().setRange(rtRange.lowerEndpoint(),
    ...
    /**
     * @see io.github.mzmine.modules.RawDataVisualizer#setIntensityRange(double,
     *      double)
     */
    ...
    public void setCursorPosition(CursorPosition newPosition) {
        ticPlot.getXYPlot()
                .setDomainCrosshairValue(newPosition.getRetentionTime(), false);
        ticPlot.getXYPlot()
                .setRangeCrosshairValue(newPosition.getIntensityValue());
    }

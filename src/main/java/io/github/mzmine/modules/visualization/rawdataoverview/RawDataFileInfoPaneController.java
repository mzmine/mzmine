...
public class RawDataFileInfoPaneController {
    ...
    @FXML private TableView<ScanDescription> rawDataTableView;

    @FXML private TableColumn<ScanDescription, String> scanColumn;

    @FXML private TableColumn<ScanDescription, String> rtColumn;

    @FXML private TableColumn<ScanDescription, Double> basePeakColumn;

    @FXML private TableColumn<ScanDescription, String> basePeakIntensityColumn;

    @FXML private TableColumn<ScanDescription, String> msLevelColumn;

    @FXML private TableColumn<ScanDescription, String> precursorMzColumn;

    @FXML private TableColumn<ScanDescription, String> mzRangeColumn;

    @FXML private TableColumn<ScanDescription, String> scanTypeColumn;

    @FXML private TableColumn<ScanDescription, String> polarityColumn;

    @FXML private TableColumn<ScanDescription, String> definitionColumn;

    @FXML private TableColumn<ScanDescription, String> mobilityColumn;

    @FXML private Label lblNumScans;

    @FXML private Label lblRtRange;

    @FXML private Label lblMzRange;

    @FXML private Label lblMaxTIC;
    ...
    private void updateRawDataFileInfo(RawDataFile rawDataFile) {
        ...
        for (int i = 0; i < rawDataFile.getMSLevels().length; i++) {
            scansMSLevel =
                scansMSLevel + "MS" + rawDataFile.getMSLevels()[i] + " level (" + rawDataFile
                    .getScanNumbers(i + 1).length + ") ";
    ...
    protected void updateScanTable(RawDataFile rawDataFile) {
        ...
        basePeakIntensityColumn
            .setCellValueFactory(new PropertyValueFactory<>("basePeakIntensity"));
    ...
    @Nonnull public Range<Integer> getVisibleRange() {
    ...
    private class PopulateTask implements Task {
        ...
        @Override public void run() {
            ...
            for (int i = 1; i < numberOfScans + 1; i++) {
                ...
                // format mzRange
                String mzRange =
                    mzFormat.format(scan.getDataPointMZRange().lowerEndpoint()) + "-" + mzFormat
        ...
        @Override public TaskPriority getTaskPriority() {

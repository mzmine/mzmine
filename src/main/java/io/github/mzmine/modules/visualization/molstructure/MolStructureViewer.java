...
public class MolStructureViewer extends JFrame {
    ...
    /**
     * Constructor of MolStructureViewer, loads 2d and 3d structures into JPanel
     * specified by urls
     * 
     * @param name
    ...
    /**
     * Constructor for MolStructureViewer from AtomContainer and only for 2D
     * object The 3D view will be unavailable
     * 
     * @param name
     * @param structure2D
     *            AtomContainer

...
public class TICToolBar extends JToolBar {
  ...
  // Icons.
  private static final Icon SHOW_SPECTRUM_ICON =
      IconUtil.loadIconFromResources("icons/spectrumicon.png");
  private static final Icon DATA_POINTS_ICON =
      IconUtil.loadIconFromResources("icons/datapointsicon.png");
  private static final Icon ANNOTATIONS_ICON =
      IconUtil.loadIconFromResources("icons/annotationsicon.png");

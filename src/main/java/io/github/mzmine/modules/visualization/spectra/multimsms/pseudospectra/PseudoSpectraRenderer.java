...
public class PseudoSpectraRenderer extends XYBarRenderer {
            ...
            public void paintBar(Graphics2D g2, XYBarRenderer renderer, int row,
                ...
                super.paintBar(g2, renderer, row, column,
                        new Rectangle2D.Double(
                                bar.getX() + (bar.getWidth() - 1.5) / 2,
                                bar.getY(), 1.5, bar.getHeight()),
                        base);
            }
        });
    }
    ...
    @Override
    protected void drawItemLabel(Graphics2D g2, XYDataset dataset, int series,
            int item, XYPlot plot, XYItemLabelGenerator generator,
        ...
        if (generator != null) {
            ...
            if (label != null) {
                ...
                if (splitted.length > 1) {
                    ...
                    int height = 4
                            + (int) gv.getPixelBounds(null, 0, 0).getHeight();

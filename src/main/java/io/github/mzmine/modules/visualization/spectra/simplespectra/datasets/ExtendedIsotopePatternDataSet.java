...
/**
 * 
 * Dataset that can contain an ExtendedIsotopePattern and convert it so it can
 * be accessed by an bar renderer. This also contains the description of the
 * datapoints so they can be displayed as a tooltip in the preview chart. The
 * tooltips can be generated by SpectraToolTipGenerator. Furthermore, a minimum
 * intensity is specified and the peaks are sorted into two different XYSeries
 * to allow a color differentiation if the relative intensities are above or
...
public class ExtendedIsotopePatternDataSet extends XYSeriesCollection {
     ...
     * 
     * @param pattern
     *            ExtendedIsotopePattern to generate the dataset from
     * @param minIntensity
     *            minimum intensity (0.0-1.0) threshold for color
     *            differentiation
     * @param width
     *            Width of the datapoints to be displayed. Used for merging the
     *            peaks.
     */
    public ExtendedIsotopePatternDataSet(ExtendedIsotopePattern pattern,
            double minIntensity, double width) {
    ...
    /**
     * By redefining this, the pattern is displayed as an actual bar instead of
     * a line
     */
    @Override

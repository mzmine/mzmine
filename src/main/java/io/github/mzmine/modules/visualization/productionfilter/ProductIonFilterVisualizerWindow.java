 ...
 */
public class ProductIonFilterVisualizerWindow extends JFrame
    ...
    public ProductIonFilterVisualizerWindow(RawDataFile dataFile,
        ...
        Range<Double> rtRange = parameters
                .getParameter(ProductIonFilterParameters.retentionTimeRange)
                .getValue();
        Range<Double> mzRange = parameters
                .getParameter(ProductIonFilterParameters.mzRange).getValue();
        Object xAxisType = parameters
                .getParameter(ProductIonFilterParameters.xAxisType).getValue();
        ...
        mzDifference = parameters
                .getParameter(ProductIonFilterParameters.mzDifference)
                .getValue();

        targetedMZ_List = parameters
                .getParameter(ProductIonFilterParameters.targetedMZ_List)
                .getValue();
        targetedNF_List = parameters
                .getParameter(ProductIonFilterParameters.targetedNF_List)
                .getValue();

        fileName = parameters.getParameter(ProductIonFilterParameters.fileName)
                .getValue();

        basePeakPercent = parameters
                .getParameter(ProductIonFilterParameters.basePeakPercent)
                .getValue();

        // Shawn

        // Set window components
        dataset = new ProductIonFilterDataSet(dataFile, xAxisType, rtRange,
                mzRange, this, mzDifference, targetedMZ_List, targetedNF_List,
                basePeakPercent, fileName);

        ProductIonFilterPlot = new ProductIonFilterPlot(this, dataset,
                xAxisType);
        ...
        ParameterSet paramSet = MZmineCore.getConfiguration()
                .getModuleParameters(ProductIonFilterVisualizerModule.class);
        WindowSettingsParameter settings = paramSet
                .getParameter(ProductIonFilterParameters.windowSettings);
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (command.equals("HIGHLIGHT")) {
            JDialog dialog = new ProductIonFilterSetHighlightDialog(
                    ProductIonFilterPlot, command);
    ...
    public ProductIonFilterDataPoint getCursorPosition() {
        double xValue = (double) ProductIonFilterPlot.getXYPlot()
                .getDomainCrosshairValue();
        double yValue = (double) ProductIonFilterPlot.getXYPlot()

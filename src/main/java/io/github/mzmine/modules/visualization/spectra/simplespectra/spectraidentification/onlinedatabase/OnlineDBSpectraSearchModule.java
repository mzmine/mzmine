...
public class OnlineDBSpectraSearchModule implements MZmineModule {
    ...
    public static void showSpectraIdentificationDialog(final Scan scan,
        ...
        final SpectraIdentificationOnlineDatabaseParameters parameters = (SpectraIdentificationOnlineDatabaseParameters) MZmineCore
                .getConfiguration()
        ...
        if (parameters.showSetupDialog(MZmineCore.getDesktop().getMainWindow(),
            ...
            MZmineCore.getTaskController()
                    .addTask(new SpectraIdentificationOnlineDatabaseTask(

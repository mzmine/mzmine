...
public class ScatterPlotBottomPanel extends JPanel implements ActionListener {
    ...
    public ScatterPlotBottomPanel(ScatterPlotWindow window,
        ...
        txtSearchField.setPreferredSize(
                new Dimension(230, txtSearchField.getPreferredSize().height));

        minSearchField = new JFormattedTextField();
        minSearchField.selectAll();
        minSearchField.setVisible(false);
        minSearchField.setPreferredSize(
                new Dimension(100, minSearchField.getPreferredSize().height));
        ...
        maxSearchField.setPreferredSize(
                new Dimension(100, maxSearchField.getPreferredSize().height));

...
public class Peptide {
  ...
  public Peptide(int queryNumber, String sequence, double ionScore2, double mass,
      double massExpected, int charge, double precursorMass, double deltaMass, int missed,
      PeptideScan scan, String identificationMethod, boolean isTopScore) {
  ...
  /**
   * Returns the delta mass or difference between the calculated mass and detected mass by the
   * instrument
   * 
   * @return deltaMass
   */

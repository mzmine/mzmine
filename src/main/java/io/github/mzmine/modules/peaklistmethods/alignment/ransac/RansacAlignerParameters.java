...
package io.github.mzmine.modules.peaklistmethods.alignment.ransac;
...
public class RansacAlignerParameters extends SimpleParameterSet {
  ...
  public ExitCode showSetupDialog(Window parent, boolean valueCheckRequired) {
    RansacAlignerSetupDialog dialog =
        new RansacAlignerSetupDialog(parent, valueCheckRequired, this);

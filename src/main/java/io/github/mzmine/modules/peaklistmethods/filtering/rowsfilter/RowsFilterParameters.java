...
package io.github.mzmine.modules.peaklistmethods.filtering.rowsfilter;
...
public class RowsFilterParameters extends SimpleParameterSet {
  ...
  public static final OptionalParameter<DoubleRangeParameter> FWHM =
      new OptionalParameter<>(new DoubleRangeParameter("Chromatographic FWHM",
  ...
  public static final BooleanParameter HAS_IDENTITIES =
      new BooleanParameter("Only identified?", "Select to filter only identified compounds");

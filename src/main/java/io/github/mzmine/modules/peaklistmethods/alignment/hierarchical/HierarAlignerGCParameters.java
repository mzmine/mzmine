...
package io.github.mzmine.modules.peaklistmethods.alignment.hierarchical;

import java.text.NumberFormat;

import io.github.mzmine.modules.peaklistmethods.alignment.hierarchical.ClustererType;
...
public class HierarAlignerGCParameters extends SimpleParameterSet {
  ...
  public static final ComboParameter<ClusteringLinkageStrategyType> linkageStartegyType_0 =
      new ComboParameter<ClusteringLinkageStrategyType>("Clustering strategy",
  ...
  // *** GLG HACK: Added...
  public static final BooleanParameter useKnownCompoundsAsRef =
      new BooleanParameter("Use RT recalibration",
          "If checked, uses compounds with known identities to ease alignment", true);
  ...
  public static final BooleanParameter exportDendrogramTxt =
      new BooleanParameter("Export dendrogram as TXT/CDT",
  ...
  public HierarAlignerGCParameters() {
    super(new Parameter[] {peakLists,
        ...
        // hybrid_K_value,
        peakListName, MZTolerance, MZWeight, RTTolerance, RTWeight, minScore,

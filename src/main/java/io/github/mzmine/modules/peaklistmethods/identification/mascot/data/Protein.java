...
import io.github.mzmine.util.ProteomeUtils;
...
public class Protein {
  ...
  /**
   * This class represents a protein, which is identified by many peptides. Also this class keeps
   * information about the section of sequence that cover each peptide and the number of hits (scan
   * number) related to this protein.
   * 
   ...
   * @param isTopScore
   */
  public void addPeptide(Peptide peptide, ProteinSection section, boolean isTopScore) {
  ...
  /**
   * Returns the section of protein's sequence information that corresponds with the peptide as
   * argument.
   * 
   * @param peptide

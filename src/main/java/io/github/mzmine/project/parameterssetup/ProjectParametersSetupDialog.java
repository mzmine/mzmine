...
public class ProjectParametersSetupDialog extends JDialog
    ...
    private boolean validateParameterValues() {
        ...
        for (int columnIndex = 0; columnIndex < parameterValues.keySet()
                .size(); columnIndex++) {
            UserParameter<?, ?> parameter = tablemodelParameterValues
            ...
            if (parameter instanceof DoubleParameter) {
                ...
                for (int dataFileIndex = 0; dataFileIndex < dataFiles.length; dataFileIndex++) {
                    Object objValue = tablemodelParameterValues
                            .getValueAt(dataFileIndex, columnIndex + 1);
    ...
    private void copyParameterValuesToRawDataFiles() {
        ...
        for (int columnIndex = 0; columnIndex < parameterValues.keySet()
            ...
            for (int dataFileIndex = 0; dataFileIndex < dataFiles.length; dataFileIndex++) {
                ...
                Object value = tablemodelParameterValues
                        .getValueAt(dataFileIndex, columnIndex + 1);
                if (parameter instanceof DoubleParameter) {
    ...
    private void initComponents() {
        ...
        panelRemoveParameterButton = new JPanel(
        ...
        panelParameterValues.add(panelRemoveParameterButton,
                BorderLayout.SOUTH);

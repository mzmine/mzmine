...
import io.github.mzmine.util.components.LabeledProgressBar;
...
public class StatusBar extends JPanel implements Runnable, MouseListener {
    ...
    public StatusBar() {
        ...
        statusTextPanel
                .setLayout(new BoxLayout(statusTextPanel, BoxLayout.X_AXIS));
        ...
        statusTextPanel
                .add(Box.createRigidArea(new Dimension(5, STATUS_BAR_HEIGHT)));
        ...
        memoryPanel
                .add(Box.createRigidArea(new Dimension(10, STATUS_BAR_HEIGHT)));
    ...
    public synchronized void run() {
        ...
        while (true) {
            ...
            memoryLabel.setToolTipText(
                    "JVM memory: " + freeMem + "MB, " + totalMem + "MB total");

...
public class JStrokeChooserDialog extends JDialog {
    ...
    public static void main(String[] args) {
        try {
            JStrokeChooserDialog dialog = new JStrokeChooserDialog(
                    new SettingsBasicStroke(1.5f));
    ...
    public JStrokeChooserDialog(SettingsBasicStroke stroke) {
        ...
        contentPanel.setLayout(new BorderLayout(0, 0));
        {
                    ...
                    new MigLayout("", "[][][][]", "[][][][][][][][grow]"));
            {
                ...
                strokeChooserPanel.getButton()
                        .setPreferredSize(new Dimension(33, 20));
                strokeChooserPanel.getButton()
                        .setMinimumSize(new Dimension(33, 20));
            ...
            }
            {
                ...
                txtArray.setToolTipText(
                        "An array of dash, space, dash, space separated by a space character");
            ...
            }
            {
                ...
                comboCap.setModel(new DefaultComboBoxModel(
                        new String[] { "Round", "Butt", "Square" }));
            ...
            }
            {
                ...
                comboJoin.setModel(new DefaultComboBoxModel(
                        new String[] { "Round", "Miter", "Bevel" }));
            ...
            }
            {
                ...
                txtPhase.setText("0");
                txtPhase.setToolTipText(
                        "The phase is an offset which shifts the pattern start");
            ...
            }
            {
                pnPreview = new JPanel() {
                    ...
                    public void paint(Graphics g) {
                        ...
                        g2.draw(createDefaultStar(r, x + r * 2 + 10,
                                y + r * 2 + 10));
        ...
        DelayedDocumentListener ddl = new DelayedDocumentListener() {
            ...
            public void documentChanged(DocumentEvent e) {
                JTextField txt = (JTextField) e.getDocument()
                        .getProperty("owner");
                try {
    ...
    protected void settingsToStroke() {
        try {
            ...
            SettingsBasicStroke s = new SettingsBasicStroke(w, cap, join,
                    miterLimit, array, phase);
            // create new
            getStrokeChooserPanel().setStroke(s);
            getStrokeChooserPanel().repaint();
            pnPreview.repaint();

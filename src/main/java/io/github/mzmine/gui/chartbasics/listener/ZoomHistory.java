...
/**
 * The ZoomHistory stores all zoom states which are active for at least 1
 * second. It allows to jump to previous and next states. To obtain the
 * ZoomHistory object from any ChartPanel use:
 * 
 * <pre>
...
public class ZoomHistory extends AxesRangeChangedListener implements Runnable {
    ...
    /**
     * Creates a ZoomHistory for the given ChartPanel as a ClientProperty. The
     * history collects all zoom states that are active for at least 1 second.
     * It allows to jump to previous and next zoom states. To obtain the
     * ZoomHistory object from any ChartPanel use:
     * 
     * <pre>
     * {@code (ZoomHistory) chartPanel.getClientProperty(ZoomHistory.PROPERTY_NAME)}
    ...
    @Override
    public void axesRangeChanged(ChartViewWrapper chart, ValueAxis axis,
    ...
    /**
     * Stops the threads run method that updates the history on axes changed
     * events
     */

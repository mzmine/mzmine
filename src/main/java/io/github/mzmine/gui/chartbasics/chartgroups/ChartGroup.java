...
public class ChartGroup {
    ...
    public ChartGroup(boolean showClickDomainMarker,
            boolean showClickRangeMarker, boolean combineDomainAxes,
            boolean combineRangeAxes) {
    ...
    private void addCrosshair(ChartViewWrapper chart) {
        ...
        if (m != null) {
            m.addGestureHandler(new ChartGestureHandler(new ChartGesture(
                    Entity.PLOT, Event.MOVED, Button.ALL, Key.ALL), e -> {
    ...
    private void combineAxes(JFreeChart chart) {
        try {
            if (combineDomainAxes && hasDomainAxis(chart)) {
                ...
                AxisRangeChangedListener listener = new AxisRangeChangedListener(
                        null) {
                    @Override
     ...
     */
    public void setCombineAxes(boolean combineDomainAxes,
            boolean combineRangeAxes) {
        if (combineDomainAxes != this.combineDomainAxes
                || combineRangeAxes != this.combineRangeAxes) {
            domainListener = null;
            rangeListener = null;
            this.combineRangeAxes = combineRangeAxes;
            this.combineDomainAxes = combineDomainAxes;
    ...
    public void setShowCrosshair(boolean showCrosshairDomain,
            boolean showCrosshairRange) {

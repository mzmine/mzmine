...
/**
 * Paint scales for XYZ datasets These scales can be used with the
 * XYBlockRenderer
 * 
...
public class XYBlockPixelSizePaintScales {
    ...
    /*
     * Method to select the right scale for the applied settings in the modules
     * kendrickmassplot and vankrevelendiagram
     */
    public static Paint[] getPaintColors(String zAxisScaleType,
            Range<Double> zScaleRange, String paintScaleStyle) {
        Paint[] scale = null;
        // lower and upper bound
        if (zAxisScaleType.contains("percentile")
                && zScaleRange.lowerEndpoint() != 0
        ...
        // lower bound
        else if (zAxisScaleType.contains("percentile")
                && zScaleRange.lowerEndpoint() != 0
                && zScaleRange.upperEndpoint() == 100) {
            if (paintScaleStyle.contains("Rainbow")) {
    ...
    /*
     * returns an array with rainbow colors with black as lower bound and
     * magenta as upper bound
     */
    ...
    public static Paint[] getRedScale() {
        ...
        for (int i = 0; i < redScale.length; i++) {
            redScale[i] = new Color(255, redScale.length - i - 1,
                    redScale.length - i - 1);
        }
    ...
    /*
     * returns an array with red colors with black as lower bound and magenta as
     * upper bound
     */
    ...
    public static Paint[] getGreenScale() {
        ...
        for (int i = 0; i < greenScale.length; i++) {
            ...
            greenScale[i] = new Color(greenScale.length - i - 1, 255,
                    greenScale.length - i - 1);
    ...
    /*
     * returns an array with green colors with black as lower bound and magenta
     * as upper bound
     */
    ...
    /*
     * returns an array with yellow colors with black as lower bound and magenta
     * as upper bound
     */
    ...
    public static Paint[] getYellowScaleUpperBound() {
        ...
        for (int i = 0; i < yellowScale.length - 5; i++) {
            yellowScale[i] = new Color(yellowScale.length - i - 1,
                    yellowScale.length - i - 1, 255);
        }
        for (int i = yellowScale.length - 5; i < yellowScale.length; i++) {
            yellowScale[i] = new Color(244, 66, 223);
        }
    ...
    /*
     * returns an array with cyan colors with black as lower bound and magenta
     * as upper bound
     */

...
public class ChartViewWrapper {
    ...
    public boolean isMouseZoomable() {
        return cp != null ? ChartLogics.isMouseZoomable(cp)
                : ChartLogicsFX.isMouseZoomable(cc);
    }
    ...
    public XYPlot findXYSubplot(double mouseX, double mouseY) {
        return cp != null
                ? ChartLogics.findXYSubplot(getChart(), getRenderingInfo(),
                        mouseX, mouseY)
                : ChartLogicsFX.findXYSubplot(getChart(), getRenderingInfo(),
                        mouseX, mouseY);
    }

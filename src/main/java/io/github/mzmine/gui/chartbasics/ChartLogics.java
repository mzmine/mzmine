...
public class ChartLogics {
    private static Logger logger = Logger
            .getLogger(ChartLogics.class.getName());
     ...
     * @throws Exception
     */
    public static Point2D mouseXYToPlotXY(ChartPanel myChart, double mouseX,
            double mouseY) throws Exception {
     ...
     * @throws Exception
     */
    public static Point2D mouseXYToPlotXY(ChartPanel myChart, int mouseX,
        ...
        if (plot != null) {
            ...
            if (domainAxis != null)
                cx = domainAxis.java2DToValue(p.getX(), dataArea,
                        domainAxisEdge);
            if (rangeAxis != null)
     ...
     * @return
     */
    public static ChartEntity findChartEntity(ChartPanel chart, double mx,
            double my) {
     ...
     * @return
     */
    public static double calcWidthOnScreen(ChartPanel myChart, double dataWidth,
            ValueAxis axis, RectangleEdge axisEdge) {
     ...
     * @return
     */
    public static Dimension calcSizeForPlotWidth(ChartPanel myChart,
            double plotWidth) {
     ...
     * @return
     */
    public static Dimension calcSizeForPlotSize(ChartPanel myChart,
    ...
    public static Dimension calcSizeForPlotSize(ChartPanel myChart,
        ...
        try {
            for (int i = 0; i < iterations; i++) {
                ...
                // panel==true)
                myChart.setSize((int) estimatedChartWidth,
     ...
     * @return
     */
    public static double calcHeightToWidth(ChartPanel myChart,
            double chartWidth, boolean copyToNewPanel) {
     ...
     * @return
     */
    public static double calcWidthToHeight(ChartPanel myChart,
            double chartHeight) {
        makeChartResizable(myChart);
        // paint on a ghost panel
        JPanel parent = (JPanel) myChart.getParent();
     ...
     * @return
     */
    public static Dimension calcMaxSize(ChartPanel myChart, double chartWidth,
            double chartHeight) {
        makeChartResizable(myChart);
        // paint on a ghost panel
        JPanel parent = (JPanel) myChart.getParent();
     ...
     */
    public static void setZoomDomainAxis(ChartPanel myChart, Range zoom,
            boolean autoRangeY) {
        XYPlot plot = (XYPlot) myChart.getChart().getPlot();
        ValueAxis domainAxis = plot.getDomainAxis();
     ...
     *            if true the range (Y) axis auto bounds will be restored
     */
    public static void offsetDomainAxis(ChartPanel myChart, double xoffset,
            boolean autoRangeY) {
        XYPlot plot = (XYPlot) myChart.getChart().getPlot();
        ValueAxis domainAxis = plot.getDomainAxis();
        // apply offset on x
     ...
     * @param autoRangeY
     */
    public static void offsetDomainAxisAbsolute(ChartPanel myChart,
     ...
     */
    public static void zoomRangeAxis(JFreeChart myChart, double yzoom,
    ...
    public static boolean isMouseZoomable(ChartPanel chartPanel) {
        return chartPanel instanceof EChartPanel
                ? ((EChartPanel) chartPanel).isMouseZoomable()

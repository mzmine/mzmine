...
/**
 * Enhanced ChartPanel with extra chart gestures (drag mouse over entities
 * (e.g., axis, titles) ZoomHistory, GraphicsExportDialog, axesRangeListener
 * included
 * 
...
public class EChartPanel extends ChartPanel {
     ...
     */
    public EChartPanel(JFreeChart chart, boolean graphicsExportMenu,
     ...
     */
    public EChartPanel(JFreeChart chart, boolean useBuffer,
            boolean graphicsExportMenu, boolean dataExportMenu,
            boolean standardGestures) {
        this(chart, useBuffer, graphicsExportMenu, dataExportMenu,
                standardGestures, false);
    }
    ...
    public EChartPanel(JFreeChart chart, boolean useBuffer,
        ...
        this(chart, useBuffer, graphicsExportMenu, dataExportMenu,
                standardGestures, true, stickyZeroForRangeAxis);
    }
    ...
    public EChartPanel(JFreeChart chart, boolean useBuffer,
            boolean graphicsExportMenu, boolean dataExportMenu,
            boolean standardGestures, boolean addZoomHistory,
    ...
    protected void addExportMenu(boolean graphics, boolean data) {
        ...
        if (data) {
            ...
            // Excel XY
            JMenuExportToExcel exportXY = new JMenuExportToExcel(
                    new XSSFExcelWriterReader(), "to Excel", this);
            export.add(exportXY);
            // clip board
            JMenuExportToClipboard exportXYClipboard = new JMenuExportToClipboard(
                    "to Clipboard", this);

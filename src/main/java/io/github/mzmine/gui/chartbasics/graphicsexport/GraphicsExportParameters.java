...
public class GraphicsExportParameters extends SimpleParameterSet {
    ...
    public static final StringParameter path = new StringParameter("Path",
            "The file path");
    public static final StringParameter filename = new StringParameter(
            "Filename", "The file name");

    public static final DoubleParameter width = new DoubleParameter("Width",
            "Uses fixed width for the chart or plot",
            DecimalFormat.getInstance(), 15.0);

    public static final DoubleParameter dpi = new DoubleParameter(
            "Resolution (dpi)",
            "dots per inch resolution (for print usually 300 up to 600 dpi)",
            DecimalFormat.getInstance(), 300.0);
    ...
    public static final ComboParameter<String> exportFormat = new ComboParameter<String>(
            "Format", "The image export format",
            new String[] { "PDF", "EMF", "EPS", "SVG", "JPG", "PNG" }, "PNG");
    ...
    public static final DoubleParameter alpha = new DoubleParameter(
            "Transparency", "Transparency from 0.0-1.0 (fully visible)",
            DecimalFormat.getInstance(), 1.0, 0.0, 1.0);

    public static final ComboParameter<DimUnit> unit = new ComboParameter<>(
            "Unit", "Unit for width and height dimensions", DimUnit.values(),
            DimUnit.CM);

    public GraphicsExportParameters() {
        super(new Parameter[] { path, filename, unit, exportFormat, fixedSize,
                width, height, dpi, color, alpha });

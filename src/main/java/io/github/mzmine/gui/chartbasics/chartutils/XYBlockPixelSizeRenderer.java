...
/**
 * A renderer that represents features from an {@link XYZDataset} by drawing a color block at each (x,
...
public class XYBlockPixelSizeRenderer extends AbstractXYItemRenderer
  ...
  /**
   * Returns the block width, in features/axis units.
   *
  ...
  /**
   * Sets the width of the blocks used to represent each features item and sends a
   * {@link RendererChangeEvent} to all registered listeners.
   *
   * @param width the new width, in features/axis units (must be &gt; 0.0).
   *
   * @see #getBlockWidth()
   */
  ...
  /**
   * Returns the block height, in features/axis units.
   *
  ...
  /**
   * Sets the height of the blocks used to represent each features item and sends a
   * {@link RendererChangeEvent} to all registered listeners.
   *
   * @param height the new height, in features/axis units (must be &gt; 0.0).
   *
   * @see #getBlockHeight()
   */
   ...
   * @param dataArea the features area.
